...
- Capped `pyspark` to `<4.0` (Spark 3.5.x) in the `kafka`/`databricks` extras: the Kafka/Avro paths load Scala 2.12 / Spark 3.5 connector jars, which are incompatible with Spark 4.x.
