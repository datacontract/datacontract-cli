...
const Qt = "Canceled";
function zs(t) {
  return t instanceof xs ? !0 : t instanceof Error && t.name === Qt && t.message === Qt;
}
...
function js(t, e = "unexpected state") {
  if (!t)
...
(function(t) {
  ...
  t.length = v;
  function* L(w, _, A = w.length) {
    for (_ < -w.length && (_ = 0), _ < 0 && (_ += w.length), A < 0 ? A += w.length : A > w.length && (A = w.length); _ < A; _++)
      yield w[_];
  }
  t.slice = L;
  function E(w, _ = Number.POSITIVE_INFINITY) {
    const A = [];
    if (_ === 0)
      return [A, w];
...
const Rn = class Rn {
  constructor() {
    this._store = new ht(), this._store;
  }
  dispose() {
    this._store.dispose();
  }
...
(function(t) {
  ...
  function n(x) {
    return (S, M = null, R) => {
      ...
      return q = x((W) => {
        if (!F)
          return q ? q.dispose() : F = !0, S.call(M, W);
      }, null, R), F && q.dispose(), q;
    };
  }
  t.once = n;
  function r(x, S) {
  ...
  t.onceIf = r;
  function s(x, S, M) {
    return h((R, F = null, q) => x((W) => R.call(F, S(W)), null, q), M);
  }
  t.map = s;
  function i(x, S, M) {
    return h((R, F = null, q) => x((W) => {
      S(W), R.call(F, W);
    }, null, q), M);
  }
  t.forEach = i;
  function l(x, S, M) {
    return h((R, F = null, q) => x((W) => S(W) && R.call(F, W), null, q), M);
  }
  t.filter = l;
  function o(x) {
    return x;
  ...
  function u(...x) {
    return (S, M = null, R) => {
      const F = Qs(...x.map((q) => q((W) => S.call(M, W))));
      return m(F, R);
    };
  }
  t.any = u;
  ...
  function f(x, S, M = 100, R = !1, F = !1, q, W) {
    let Q, Z, Re, bt = 0, tt;
    const qs = {
      leakWarningThreshold: q,
      onWillAddFirstListener() {
        Q = x((Us) => {
          bt++, Z = S(Z, Us), R && !Re && (pt.fire(Z), Z = void 0), tt = () => {
            const $s = Z;
            Z = void 0, Re = void 0, (!R || bt > 1) && pt.fire($s), bt = 0;
          }, typeof M == "number" ? (Re && clearTimeout(Re), Re = setTimeout(tt, M)) : Re === void 0 && (Re = null, queueMicrotask(tt));
        });
      },
    ...
    return W?.add(pt), pt.event;
  }
  t.debounce = f;
  function p(x, S = 0, M) {
    return t.debounce(x, (R, F) => R ? (R.push(F), R) : [F], S, void 0, !0, void 0, M);
  }
  t.accumulate = p;
  function g(x, S = (R, F) => R === F, M) {
    let R = !0, F;
    return l(x, (q) => {
      const W = R || !S(q, F);
      return R = !1, F = q, W;
  ...
  t.split = d;
  function y(x, S = !1, M = [], R) {
    let F = M.slice(), q = x((Z) => {
      F ? F.push(Z) : Q.fire(Z);
    });
    R && R.add(q);
    const W = () => {
      F?.forEach((Z) => Q.fire(Z)), F = null;
    }, Q = new fe({
      onWillAddFirstListener() {
        q || (q = x((Z) => Q.fire(Z)), R && R.add(q));
      },
  ...
  class L {
    ...
    forEach(S) {
      return this.steps.push((M) => (S(M), M)), this;
    }
    filter(S) {
      return this.steps.push((M) => S(M) ? M : v), this;
    }
    reduce(S, M) {
      let R = M;
  ...
  function E(x, S, M = (R) => R) {
    const R = (...Q) => W.fire(M(...Q)), F = () => x.on(S, R), q = () => x.removeListener(S, R), W = new fe({ onWillAddFirstListener: F, onDidRemoveLastListener: q });
    return W.event;
  }
  t.fromNodeEventEmitter = E;
  function T(x, S, M = (R) => R) {
    const R = (...Q) => W.fire(M(...Q)), F = () => x.addEventListener(S, R), q = () => x.removeEventListener(S, R), W = new fe({ onWillAddFirstListener: F, onDidRemoveLastListener: q });
    return W.event;
  }
  t.fromDOMEventEmitter = T;
  function I(x, S) {
    let M;
    const R = new Promise((F, q) => {
      const W = n(x)(F, null, S);
      M = () => W.dispose();
    });
    return R.cancel = M, R;
  }
  ...
  class A {
    constructor(S, M) {
      ...
      this.emitter = new fe(R), M && M.add(this.emitter);
    }
    beginUpdate(S) {
      this._counter++;
    }
  ...
  function D(x, S) {
    return new A(x, S).emitter.event;
  }
  t.fromObservable = D;
  function B(x) {
    return (S, M, R) => {
      ...
      const W = {
        ...
        endUpdate() {
          F--, F === 0 && (x.reportChanges(), q && (q = !1, S.call(M)));
        },
      ...
      x.addObserver(W), x.reportChanges();
      const Q = {
        dispose() {
          x.removeObserver(W);
        }
      };
      return R instanceof ht ? R.add(Q) : Array.isArray(R) && R.push(Q), Q;
    };
  }
...
const ze = class ze {
  constructor(e) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${e}_${ze._idPool++}`, ze.all.add(this);
  }
  start(e) {
    this._stopWatch = new Ut(), this.listenerCount = e;
  }
  stop() {
    if (this._stopWatch) {
...
ze.all = /* @__PURE__ */ new Set(), ze._idPool = 0;
let Yt = ze, Ks = -1;
const Vt = class Vt {
  constructor(e, n, r = (Vt._idPool++).toString(16).padStart(3, "0")) {
  ...
  check(e, n) {
    ...
    if (this._stacks.set(e.value, s + 1), this._warnCountdown -= 1, this._warnCountdown <= 0) {
      ...
      const [i, l] = this.getMostFrequentStack(), o = `[${this.name}] potential listener LEAK detected, having ${n} listeners already. MOST frequent listener (${l}):`;
...
class fe {
  constructor(e) {
    this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new Zt(e?.onListenerError ?? _t, this._options?.leakWarningThreshold ?? Ks) : void 0, this._perfMon = this._options?._profName ? new Yt(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (e, n, r) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(o);
        const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], c = new ti(`${o}. HINT: Stack shows most frequent listener (${u[1]}-times)`, u[0]);
        return (this._options?.onListenerError || _t)(c), Te.None;
      }
      if (this._disposed)
        return Te.None;
      n && (e = e.bind(n));
      const s = new $t(e);
      let i;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = Ln.create(), i = this._leakageMon.check(s.stack, this._size + 1)), this._listeners ? this._listeners instanceof $t ? (this._deliveryQueue ??= new ri(), this._listeners = [this._listeners, s]) : this._listeners.push(s) : (this._options?.onWillAddFirstListener?.(this), this._listeners = s, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
      const l = Rt(() => {
        i?.(), this._removeListener(s);
      });
      return r instanceof ht ? r.add(l) : Array.isArray(r) && r.push(l), l;
    }, this._event;
  }
  _removeListener(e) {
    ...
    if (this._size * ni <= n.length) {
      let i = 0;
      for (let l = 0; l < n.length; l++)
        n[l] ? n[i++] = n[l] : s && i < this._deliveryQueue.end && (this._deliveryQueue.end--, i < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = i;
    }
  }
  _deliver(e, n) {
    if (!e)
      return;
    const r = this._options?.onListenerError || _t;
    if (!r) {
      e.value(n);
      return;
    }
   ...
   */
  fire(e) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof $t)
...
const ii = vs() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function En(t, e) {
  let n;
...
const $e = "en";
let Kt = !1, en = !1, Ht = !1, wt, Wt = $e, Mn = $e, li, we;
const ke = globalThis;
let ne;
typeof ke.vscode < "u" && typeof ke.vscode.process < "u" ? ne = ke.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (ne = process);
const oi = typeof ne?.versions?.electron == "string", ui = oi && ne?.type === "renderer";
if (typeof ne == "object") {
  Kt = ne.platform === "win32", en = ne.platform === "darwin", Ht = ne.platform === "linux", Ht && ne.env.SNAP && ne.env.SNAP_REVISION, ne.env.CI || ne.env.BUILD_ARTIFACTSTAGINGDIRECTORY || ne.env.GITHUB_WORKSPACE, wt = $e, Wt = $e;
  const t = ne.env.VSCODE_NLS_CONFIG;
  if (t)
    try {
      const e = JSON.parse(t);
      wt = e.userLocale, Mn = e.osLocale, Wt = e.resolvedLanguage || $e, li = e.languagePack?.translationsConfigFile;
    } catch {
    }
} else typeof navigator == "object" && !ui ? (we = navigator.userAgent, Kt = we.indexOf("Windows") >= 0, en = we.indexOf("Macintosh") >= 0, (we.indexOf("Macintosh") >= 0 || we.indexOf("iPad") >= 0 || we.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Ht = we.indexOf("Linux") >= 0, we?.indexOf("Mobi") >= 0, Wt = vs() || $e, wt = navigator.language.toLowerCase(), Mn = wt) : console.error("Unable to resolve platform.");
const mt = Kt, ci = en, ge = we, hi = typeof ke.postMessage == "function" && !ke.importScripts;
(() => {
  if (hi) {
    const t = [];
    ...
    return (n) => {
      ...
      t.push({
        id: r,
        callback: n
      }), ke.postMessage({ vscodeScheduleAsyncWork: r }, "*");
    };
  }
  return (t) => setTimeout(t);
})();
const mi = !!(ge && ge.indexOf("Chrome") >= 0);
ge && ge.indexOf("Firefox") >= 0;
!mi && ge && ge.indexOf("Safari") >= 0;
ge && ge.indexOf("Edg/") >= 0;
...
class tn {
  constructor(e) {
    this.executor = e, this._state = Ce.Uninitialized;
  }
  /**
   ...
   */
  get value() {
    if (this._state === Ce.Uninitialized) {
      this._state = Ce.Running;
      try {
        this._value = this.executor();
      } catch (e) {
        this._error = e;
      } finally {
        this._state = Ce.Completed;
      }
    } else if (this._state === Ce.Running)
...
const me = class me {
  static getInstance(e) {
    return me.cache.get(Array.from(e));
  }
  static getLocales() {
...
me.ambiguousCharacterData = new tn(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), me.cache = new di({ getCacheKey: JSON.stringify }, (e) => {
  ...
  let l = e.filter((h) => !h.startsWith("_") && h in i);
  ...
  const u = n(i._common), c = r(u, o);
  return new me(c);
}), me._locales = new tn(() => Object.keys(me.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")));
let ft = me;
const Ge = class Ge {
  static getRawData() {
  ...
  static getData() {
    return this._data || (this._data = new Set([...Object.values(Ge.getRawData())].flat())), this._data;
  }
  static isInvisibleCharacter(e) {
    return Ge.getData().has(e);
  }
...
Ge._data = void 0;
let it = Ge;
const zt = "default", Ri = "$initialize";
class Ci {
...
class Pi {
  ...
  listen(e, n, r) {
    ...
    const i = new fe({
      onWillAddFirstListener: () => {
        s = String(++this._lastSentReq), this._pendingEmitters.set(s, i), this._send(new Ei(this._workerId, s, e, n, r));
      },
      onDidRemoveLastListener: () => {
  ...
  createProxyToRemoteChannel(e, n) {
    const r = {
      get: (s, i) => (typeof i == "string" && !s[i] && (As(i) ? s[i] = (l) => this.listen(e, i, l) : Ss(i) ? s[i] = this.listen(e, i, void 0) : i.charCodeAt(0) === 36 && (s[i] = async (...l) => (await n?.(), this.sendMessage(e, i, l)))), s[i])
    };
  ...
  _handleRequestMessage(e) {
    ...
    this._handler.handleMessage(e.channel, e.method, e.args).then((s) => {
      this._send(new kn(this._workerId, n, s, void 0));
    }, (s) => {
      s.detail instanceof Error && (s.detail = Xt(s.detail)), this._send(new kn(this._workerId, n, void 0, Xt(s)));
    });
  }
  _handleSubscribeEventMessage(e) {
    const n = e.req, r = this._handler.handleEvent(e.channel, e.eventName, e.arg)((s) => {
      this._send(new Mi(this._workerId, n, s));
    });
...
function Ss(t) {
  return t[0] === "o" && t[1] === "n" && Ns(t.charCodeAt(2));
}
function As(t) {
  return /^onDynamic/.test(t) && Ns(t.charCodeAt(9));
}
class Fi {
  constructor(e, n) {
  ...
  _handleMessage(e, n, r) {
    ...
    const s = e === zt ? this.requestHandler : this._localChannels.get(e);
    if (!s)
...
function Ti(t) {
  ...
  Pn = !0;
  const e = new Fi((n) => globalThis.postMessage(n), (n) => t(n));
...
function Vi(t, e, n) {
  return new Ne(new Tn(t), new Tn(e)).ComputeDiff(n).changes;
}
class De {
  static Assert(e, n) {
    if (!e)
...
class Ne {
  ...
  constructor(e, n, r = null) {
    ...
    const [s, i, l] = Ne._getElements(e), [o, u, c] = Ne._getElements(n);
  ...
  ElementsAreStrictEqual(e, n) {
    if (!this.ElementsAreEqual(e, n))
      return !1;
    const r = Ne._getStrictElement(this._originalSequence, e), s = Ne._getStrictElement(this._modifiedSequence, n);
    return r === s;
  }
  ...
  ComputeDiffRecursive(e, n, r, s, i) {
    ...
    if (e > n || r > s) {
      let m;
      return r <= s ? (De.Assert(e === n + 1, "originalStart should only be one more than originalEnd"), m = [
        new Le(e, 0, r, s - r + 1)
      ]) : e <= n ? (De.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"), m = [
        new Le(e, n - e + 1, r, 0)
      ]) : (De.Assert(e === n + 1, "originalStart should only be one more than originalEnd"), De.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"), m = []), m;
    }
    const l = [0], o = [0], u = this.ComputeRecursionPoint(e, n, r, s, l, o, i), c = l[0], h = o[0];
    if (u !== null)
      return u;
    if (!i[0]) {
      ...
      let f = [];
      return i[0] ? f = [
        new Le(c + 1, n - (c + 1) + 1, h + 1, s - (h + 1) + 1)
      ] : f = this.ComputeDiffRecursive(c + 1, n, h + 1, s, i), this.ConcatenateChanges(m, f);
    }
    return [
      new Le(e, n - e + 1, r, s - r + 1)
    ];
  }
  WALKTRACE(e, n, r, s, i, l, o, u, c, h, m, f, p, g, d, y, N, v) {
    let L = null, E = null, T = new Dn(), I = n, w = r, _ = p[0] - y[0] - s, A = -1073741824, D = this.m_forwardHistory.length - 1;
    do {
      const B = _ + e;
      B === I || B < w && c[B - 1] < c[B + 1] ? (m = c[B + 1], g = m - _ - s, m < A && T.MarkNextChange(), A = m, T.AddModifiedElement(m + 1, g), _ = B + 1 - e) : (m = c[B - 1] + 1, g = m - _ - s, m < A && T.MarkNextChange(), A = m - 1, T.AddOriginalElement(m, g + 1), _ = B - 1 - e), D >= 0 && (c = this.m_forwardHistory[D], e = c[0], I = 1, w = c.length - 1);
    } while (--D >= -1);
    if (L = T.getReverseChanges(), v[0]) {
      let B = p[0] + 1, x = y[0] + 1;
      if (L !== null && L.length > 0) {
        const S = L[L.length - 1];
        B = Math.max(B, S.getOriginalEnd()), x = Math.max(x, S.getModifiedEnd());
      }
      E = [
        new Le(B, f - B + 1, x, d - x + 1)
      ];
    } else {
      T = new Dn(), I = l, w = o, _ = p[0] - y[0] - u, A = 1073741824, D = N ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const B = _ + i;
        B === I || B < w && h[B - 1] >= h[B + 1] ? (m = h[B + 1] - 1, g = m - _ - u, m > A && T.MarkNextChange(), A = m + 1, T.AddOriginalElement(m + 1, g + 1), _ = B + 1 - i) : (m = h[B - 1], g = m - _ - u, m > A && T.MarkNextChange(), A = m, T.AddModifiedElement(m + 1, g + 1), _ = B - 1 - i), D >= 0 && (h = this.m_reverseHistory[D], i = h[0], I = 1, w = h.length - 1);
      } while (--D >= -1);
      E = T.getChanges();
    }
  ...
  ComputeRecursionPoint(e, n, r, s, i, l, o) {
    let u = 0, c = 0, h = 0, m = 0, f = 0, p = 0;
    e--, r--, i[0] = 0, l[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
    const g = n - e + (s - r), d = g + 1, y = new Int32Array(d), N = new Int32Array(d), v = s - r, L = n - e, E = e - r, T = n - s, w = (L - v) % 2 === 0;
    y[v] = e, N[L] = n, o[0] = !1;
    for (let _ = 1; _ <= g / 2 + 1; _++) {
      let A = 0, D = 0;
      h = this.ClipDiagonalBound(v - _, _, v, d), m = this.ClipDiagonalBound(v + _, _, v, d);
      for (let x = h; x <= m; x += 2) {
        x === h || x < m && y[x - 1] < y[x + 1] ? u = y[x + 1] : u = y[x - 1] + 1, c = u - (x - v) - E;
        const S = u;
        for (; u < n && c < s && this.ElementsAreEqual(u + 1, c + 1); )
          u++, c++;
        if (y[x] = u, u + c > A + D && (A = u, D = c), !w && Math.abs(x - L) <= _ - 1 && u >= N[x])
          return i[0] = u, l[0] = c, S <= N[x] && _ <= 1448 ? this.WALKTRACE(v, h, m, E, L, f, p, T, y, N, u, n, i, c, s, l, w, o) : null;
      }
      const B = (A - e + (D - r) - _) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(A, B))
        return o[0] = !0, i[0] = A, l[0] = D, B > 0 && _ <= 1448 ? this.WALKTRACE(v, h, m, E, L, f, p, T, y, N, u, n, i, c, s, l, w, o) : (e++, r++, [
          new Le(e, n - e + 1, r, s - r + 1)
        ]);
      f = this.ClipDiagonalBound(L - _, _, L, d), p = this.ClipDiagonalBound(L + _, _, L, d);
      for (let x = f; x <= p; x += 2) {
        x === f || x < p && N[x - 1] >= N[x + 1] ? u = N[x + 1] - 1 : u = N[x - 1], c = u - (x - L) - T;
        const S = u;
        for (; u > e && c > r && this.ElementsAreEqual(u, c); )
          u--, c--;
        if (N[x] = u, w && Math.abs(x - v) <= _ && u <= y[x])
          return i[0] = u, l[0] = c, S >= y[x] && _ <= 1448 ? this.WALKTRACE(v, h, m, E, L, f, p, T, y, N, u, n, i, c, s, l, w, o) : null;
      }
      if (_ <= 1447) {
        let x = new Int32Array(m - h + 2);
        x[0] = v - h + 1, Ve.Copy2(y, h, x, 1, m - h + 1), this.m_forwardHistory.push(x), x = new Int32Array(p - f + 2), x[0] = L - f + 1, Ve.Copy2(N, f, x, 1, p - f + 1), this.m_reverseHistory.push(x);
      }
    }
    return this.WALKTRACE(v, h, m, E, L, f, p, T, y, N, u, n, i, c, s, l, w, o);
  }
  /**
  ...
  PrettifyChanges(e) {
    for (let n = 0; n < e.length; n++) {
      const r = e[n], s = n < e.length - 1 ? e[n + 1].originalStart : this._originalElementsOrHash.length, i = n < e.length - 1 ? e[n + 1].modifiedStart : this._modifiedElementsOrHash.length, l = r.originalLength > 0, o = r.modifiedLength > 0;
    ...
    for (let n = e.length - 1; n >= 0; n--) {
      ...
      for (let m = 1; ; m++) {
        const f = r.originalStart - m, p = r.modifiedStart - m;
        if (f < s || p < i || l && !this.OriginalElementsAreEqual(f, f + r.originalLength) || o && !this.ModifiedElementsAreEqual(p, p + r.modifiedLength))
          break;
        const d = (f === s && p === i ? 5 : 0) + this._boundaryScore(f, r.originalLength, p, r.modifiedLength);
        d > c && (c = d, u = m);
      }
    ...
    if (this._hasStrings)
      for (let n = 1, r = e.length; n < r; n++) {
        const s = e[n - 1], i = e[n], l = i.originalStart - s.originalStart - s.originalLength, o = s.originalStart, u = i.originalStart + i.originalLength, c = u - o, h = s.modifiedStart, m = i.modifiedStart + i.modifiedLength, f = m - h;
        if (l < 5 && c < 20 && f < 20) {
          const p = this._findBetterContiguousSequence(o, c, h, f, l);
          if (p) {
            const [g, d] = p;
            (g !== s.originalStart + s.originalLength || d !== s.modifiedStart + s.modifiedLength) && (s.originalLength = g - s.originalStart, s.modifiedLength = d - s.modifiedStart, i.originalStart = g + l, i.modifiedStart = d + l, i.originalLength = u - i.originalStart, i.modifiedLength = m - i.modifiedStart);
          }
        }
      }
    return e;
  ...
  _boundaryScore(e, n, r, s) {
    const i = this._OriginalRegionIsBoundary(e, n) ? 1 : 0, l = this._ModifiedRegionIsBoundary(r, s) ? 1 : 0;
    return i + l;
  }
  /**
  ...
  ConcatenateChanges(e, n) {
    ...
    if (this.ChangesOverlap(e[e.length - 1], n[0], r)) {
      ...
      return Ve.Copy(e, 0, s, 0, e.length - 1), s[e.length - 1] = r[0], Ve.Copy(n, 1, s, e.length, n.length - 1), s;
    } else {
      const s = new Array(e.length + n.length);
      return Ve.Copy(e, 0, s, 0, e.length), Ve.Copy(n, 0, s, e.length, n.length), s;
    }
  }
  /**
  ...
  ChangesOverlap(e, n, r) {
    if (De.Assert(e.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), De.Assert(e.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= n.originalStart || e.modifiedStart + e.modifiedLength >= n.modifiedStart) {
      const s = e.originalStart;
      let i = e.originalLength;
      const l = e.modifiedStart;
      let o = e.modifiedLength;
      return e.originalStart + e.originalLength >= n.originalStart && (i = n.originalStart + n.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= n.modifiedStart && (o = n.modifiedStart + n.modifiedLength - e.modifiedStart), r[0] = new Le(s, i, l, o), !0;
    } else
      return r[0] = null, !1;
  }
  /**
...
class H {
  ...
  static compare(e, n) {
    ...
    if (r === s) {
      const i = e.column | 0, l = n.column | 0;
      return i - l;
    }
    return r - s;
  }
...
class C {
  ...
  static plusRange(e, n) {
    let r, s, i, l;
    return n.startLineNumber < e.startLineNumber ? (r = n.startLineNumber, s = n.startColumn) : n.startLineNumber === e.startLineNumber ? (r = n.startLineNumber, s = Math.min(n.startColumn, e.startColumn)) : (r = e.startLineNumber, s = e.startColumn), n.endLineNumber > e.endLineNumber ? (i = n.endLineNumber, l = n.endColumn) : n.endLineNumber === e.endLineNumber ? (i = n.endLineNumber, l = Math.max(n.endColumn, e.endColumn)) : (i = e.endLineNumber, l = e.endColumn), new C(r, s, i, l);
  }
  /**
  ...
  static intersectRanges(e, n) {
    let r = e.startLineNumber, s = e.startColumn, i = e.endLineNumber, l = e.endColumn;
    const o = n.startLineNumber, u = n.startColumn, c = n.endLineNumber, h = n.endColumn;
    return r < o ? (r = o, s = u) : r === o && (s = Math.max(s, u)), i > c ? (i = c, l = h) : i === c && (l = Math.min(l, h)), r > i || r === i && s > l ? null : new C(r, s, i, l);
  }
  /**
  ...
  static compareRangesUsingStarts(e, n) {
    if (e && n) {
      const i = e.startLineNumber | 0, l = n.startLineNumber | 0;
      if (i === l) {
        const o = e.startColumn | 0, u = n.startColumn | 0;
        if (o === u) {
          const c = e.endLineNumber | 0, h = n.endLineNumber | 0;
          if (c === h) {
            const m = e.endColumn | 0, f = n.endColumn | 0;
            return m - f;
          }
          return c - h;
        }
...
class Ct {
  ...
  static computeLinks(e, n = qi()) {
    ...
    for (let i = 1, l = e.getLineCount(); i <= l; i++) {
      const o = e.getLineContent(i), u = o.length;
      let c = 0, h = 0, m = 0, f = 1, p = !1, g = !1, d = !1, y = !1;
      for (; c < u; ) {
        let N = !1;
        ...
        if (f === 13) {
          ...
          L === 1 && (s.push(Ct._createLink(r, o, i, h, c)), N = !0);
        } else if (f === 12) {
          let L;
          v === 91 ? (g = !0, L = 0) : L = r.get(v), L === 1 ? N = !0 : f = 13;
        } else
          f = n.nextState(f, v), f === 0 && (N = !0);
        N && (f = 1, p = !1, g = !1, y = !1, h = c + 1, m = v), c++;
      }
      f === 13 && s.push(Ct._createLink(r, o, i, h, u));
    }
    return s;
  }
}
...
It.INSTANCE = new It();
let rn = It;
const Rs = Object.freeze(function(t, e) {
...
(function(t) {
  function e(n) {
    return n === t.None || n === t.Cancelled || n instanceof Lt ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class Lt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? Rs : (this._emitter || (this._emitter = new fe()), this._emitter.event);
  }
  dispose() {
...
class Hi {
  ...
  cancel() {
    this._token ? this._token instanceof Lt && this._token.cancel() : this._token = Et.Cancelled;
  }
  dispose(e = !1) {
    e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof Lt && this._token.dispose() : this._token = Et.None;
  }
}
class Nn {
  constructor() {
...
const vt = new Nn(), sn = new Nn(), an = new Nn(), Wi = new Array(230), zi = /* @__PURE__ */ Object.create(null), Gi = /* @__PURE__ */ Object.create(null);
(function() {
  const e = [
  ...
  for (const s of e) {
    ...
    if (r[l] || (r[l] = !0, zi[o] = l, Gi[o.toLowerCase()] = l), !n[u]) {
      ...
      vt.define(u, c), sn.define(u, f || c), an.define(u, p || f || c);
    }
    h && (Wi[h] = u);
  }
})();
...
(function(t) {
  ...
  t.toString = e;
  function n(o) {
    return vt.strToKeyCode(o);
  }
  t.fromString = n;
  function r(o) {
    return sn.keyCodeToStr(o);
  }
  ...
  function i(o) {
    return sn.strToKeyCode(o) || an.strToKeyCode(o);
  }
...
if (typeof jt < "u" && typeof jt.process < "u") {
  ...
  // Supported
  get platform() {
    return mt ? "win32" : ci ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const Mt = Xe.cwd, Oi = Xe.env, Xi = Xe.platform, Qi = 65, Ji = 97, Yi = 90, Zi = 122, Pe = 46, J = 47, ee = 92, be = 58, Ki = 63;
...
function ea(t, e) {
  if (t === null || typeof t != "object")
    throw new Cs(e, "Object", t);
}
function X(t, e) {
  if (typeof t != "string")
    throw new Cs(e, "string", t);
}
const Ae = Xi === "win32";
function V(t) {
  return t === J || t === ee;
...
function kt(t, e, n, r) {
  ...
  for (let c = 0; c <= t.length; ++c) {
    ...
    if (r(u)) {
      if (!(l === c - 1 || o === 1)) if (o === 2) {
        if (s.length < 2 || i !== 2 || s.charCodeAt(s.length - 1) !== Pe || s.charCodeAt(s.length - 2) !== Pe) {
          if (s.length > 2) {
        ...
        s.length > 0 ? s += `${n}${t.slice(l + 1, c)}` : s = t.slice(l + 1, c), i = c - l - 1;
      l = c, o = 0;
    } else u === Pe && o !== -1 ? ++o : o = -1;
  }
  return s;
...
function Es(t, e) {
  ea(e, "pathObject");
  const n = e.dir || e.root, r = e.base || `${e.name || ""}${ta(e.ext)}`;
...
const K = {
    ...
    for (let s = t.length - 1; s >= -1; s--) {
      ...
      if (s >= 0) {
        if (i = t[s], X(i, `paths[${s}]`), i.length === 0)
          continue;
      } else e.length === 0 ? i = Mt() : (i = Oi[`=${e}`] || Mt(), (i === void 0 || i.slice(0, 2).toLowerCase() !== e.toLowerCase() && i.charCodeAt(2) === ee) && (i = `${e}\\`));
      const l = i.length;
      let o = 0, u = "", c = !1;
      ...
      if (l === 1)
        ...
        if (c = !0, V(i.charCodeAt(1))) {
          let m = 2, f = m;
          for (; m < l && !V(i.charCodeAt(m)); )
            m++;
          if (m < l && m !== f) {
            const p = i.slice(f, m);
            for (f = m; m < l && V(i.charCodeAt(m)); )
              m++;
            if (m < l && m !== f) {
              for (f = m; m < l && !V(i.charCodeAt(m)); )
                m++;
              (m === l || m !== f) && (u = `\\\\${p}\\${i.slice(f, m)}`, o = m);
            }
          }
        } else
          o = 1;
      else pe(h) && i.charCodeAt(1) === be && (u = i.slice(0, 2), o = 2, l > 2 && V(i.charCodeAt(2)) && (c = !0, o = 3));
      if (u.length > 0)
        if (e.length > 0) {
  ...
  normalize(t) {
    ...
    if (V(i))
      if (s = !0, V(t.charCodeAt(1))) {
        let o = 2, u = o;
        for (; o < e && !V(t.charCodeAt(o)); )
          o++;
        if (o < e && o !== u) {
          const c = t.slice(u, o);
          for (u = o; o < e && V(t.charCodeAt(o)); )
            o++;
          if (o < e && o !== u) {
            for (u = o; o < e && !V(t.charCodeAt(o)); )
              o++;
        ...
        n = 1;
    else pe(i) && t.charCodeAt(1) === be && (r = t.slice(0, 2), n = 2, e > 2 && V(t.charCodeAt(2)) && (s = !0, n = 3));
    let l = n < e ? kt(t.slice(n), !s, "\\", V) : "";
    if (l.length === 0 && !s && (l = "."), l.length > 0 && V(t.charCodeAt(e - 1)) && (l += "\\"), !s && r === void 0 && t.includes(":")) {
      if (l.length >= 2 && pe(l.charCodeAt(0)) && l.charCodeAt(1) === be)
        return `.\\${l}`;
      let o = t.indexOf(":");
      do
        if (o === e - 1 || V(t.charCodeAt(o + 1)))
          return `.\\${l}`;
  ...
  isAbsolute(t) {
    ...
    e > 2 && pe(n) && t.charCodeAt(1) === be && V(t.charCodeAt(2));
  },
  join(...t) {
    if (t.length === 0)
      return ".";
    ...
    if (typeof n == "string" && V(n.charCodeAt(0))) {
      ++s;
      const i = n.length;
      i > 1 && V(n.charCodeAt(1)) && (++s, i > 2 && (V(n.charCodeAt(2)) ? ++s : r = !1));
    }
    if (r) {
      for (; s < e.length && V(e.charCodeAt(s)); )
        s++;
      s >= 2 && (e = `\\${e.slice(s)}`);
    }
  ...
  relative(t, e) {
    if (X(t, "from"), X(e, "to"), t === e)
      return "";
    const n = K.resolve(t), r = K.resolve(e);
    ...
    if (n.length !== t.length || r.length !== e.length) {
      ...
      const y = g.length, N = d.length, v = y < N ? y : N;
      let L;
      for (L = 0; L < v && g[L].toLowerCase() === d[L].toLowerCase(); L++)
        ;
      return L === 0 ? r : L === v ? N > v ? d.slice(L).join("\\") : y > v ? "..\\".repeat(y - 1 - L) + ".." : "" : "..\\".repeat(y - L) + d.slice(L).join("\\");
    }
    let s = 0;
    for (; s < t.length && t.charCodeAt(s) === ee; )
      s++;
    let i = t.length;
    for (; i - 1 > s && t.charCodeAt(i - 1) === ee; )
      i--;
    const l = i - s;
    let o = 0;
    for (; o < e.length && e.charCodeAt(o) === ee; )
      o++;
    let u = e.length;
    for (; u - 1 > o && e.charCodeAt(u - 1) === ee; )
      u--;
    const c = u - o, h = l < c ? l : c;
    let m = -1, f = 0;
    for (; f < h; f++) {
      const g = t.charCodeAt(s + f);
      if (g !== e.charCodeAt(o + f))
        break;
      g === ee && (m = f);
    }
    if (f !== h) {
      ...
      if (c > h) {
        if (e.charCodeAt(o + f) === ee)
          return r.slice(o + f + 1);
        if (f === 2)
          return r.slice(o + f);
      }
      l > h && (t.charCodeAt(s + f) === ee ? m = f : f === 2 && (m = 3)), m === -1 && (m = 0);
    }
    let p = "";
    for (f = s + m + 1; f <= i; ++f)
      (f === i || t.charCodeAt(f) === ee) && (p += p.length === 0 ? ".." : "\\..");
    return o += m, p.length > 0 ? `${p}${r.slice(o, u)}` : (r.charCodeAt(o) === ee && ++o, r.slice(o, u));
  },
  toNamespacedPath(t) {
    ...
    } else if (pe(e.charCodeAt(0)) && e.charCodeAt(1) === be && e.charCodeAt(2) === ee)
      return `\\\\?\\${e}`;
    return e;
  },
  dirname(t) {
    ...
    } else pe(s) && t.charCodeAt(1) === be && (n = e > 2 && V(t.charCodeAt(2)) ? 3 : 2, r = n);
    let i = -1, l = !0;
    for (let o = e - 1; o >= r; --o)
      if (V(t.charCodeAt(o))) {
        if (!l) {
  ...
  basename(t, e) {
    ...
    let n = 0, r = -1, s = !0, i;
    if (t.length >= 2 && pe(t.charCodeAt(0)) && t.charCodeAt(1) === be && (n = 2), e !== void 0 && e.length > 0 && e.length <= t.length) {
      if (e === t)
        return "";
      let l = e.length - 1, o = -1;
      for (i = t.length - 1; i >= n; --i) {
        ...
        if (V(u)) {
          ...
          o === -1 && (s = !1, o = i + 1), l >= 0 && (u === e.charCodeAt(l) ? --l === -1 && (r = i) : (l = -1, r = o));
      }
  ...
  extname(t) {
    X(t, "path");
    let e = 0, n = -1, r = 0, s = -1, i = !0, l = 0;
    t.length >= 2 && t.charCodeAt(1) === be && pe(t.charCodeAt(0)) && (e = r = 2);
  ...
  parse(t) {
    ...
    if (n === 1)
      return V(s) ? (e.root = e.dir = t, e) : (e.base = e.name = t, e);
    if (V(s)) {
      if (r = 1, V(t.charCodeAt(1))) {
        let m = 2, f = m;
        for (; m < n && !V(t.charCodeAt(m)); )
          m++;
        if (m < n && m !== f) {
          for (f = m; m < n && V(t.charCodeAt(m)); )
            m++;
          if (m < n && m !== f) {
            for (f = m; m < n && !V(t.charCodeAt(m)); )
              m++;
    ...
    } else if (pe(s) && t.charCodeAt(1) === be) {
      if (n <= 2)
        return e.root = e.dir = t, e;
      if (r = 2, V(t.charCodeAt(2))) {
        if (n === 3)
          return e.root = e.dir = t, e;
        r = 3;
      }
    ...
    let i = -1, l = r, o = -1, u = !0, c = t.length - 1, h = 0;
    for (; c >= r; --c) {
      if (s = t.charCodeAt(c), V(s)) {
        if (!u) {
          l = c + 1;
          break;
        }
      ...
      o === -1 && (u = !1, o = c + 1), s === Pe ? i === -1 ? i = c : h !== 1 && (h = 1) : i !== -1 && (h = -1);
    }
    return o !== -1 && (i === -1 || // We saw a non-dot character immediately before the dot
    h === 0 || // The (right-most) trimmed path component is exactly '..'
    h === 1 && i === o - 1 && i === l + 1 ? e.base = e.name = t.slice(l, o) : (e.name = t.slice(l, i), e.base = t.slice(l, o), e.ext = t.slice(i, o))), l > 0 && l !== r ? e.dir = t.slice(0, l - 1) : e.dir = e.root, e;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...t) {
    ...
    return e = kt(e, !n, "/", ln), n ? `/${e}` : e.length > 0 ? e : ".";
  },
  normalize(t) {
    if (X(t, "path"), t.length === 0)
      return ".";
    const e = t.charCodeAt(0) === J, n = t.charCodeAt(t.length - 1) === J;
    return t = kt(t, !e, "/", ln), t.length === 0 ? e ? "/" : n ? "./" : "." : (n && (t += "/"), e ? `/${t}` : t);
  },
  isAbsolute(t) {
  ...
  relative(t, e) {
    if (X(t, "from"), X(e, "to"), t === e || (t = re.resolve(t), e = re.resolve(e), t === e))
      return "";
    const n = 1, r = t.length, s = r - n, i = 1, l = e.length - i, o = s < l ? s : l;
    let u = -1, c = 0;
    for (; c < o; c++) {
      const m = t.charCodeAt(n + c);
      if (m !== e.charCodeAt(i + c))
        break;
      m === J && (u = c);
    }
    if (c === o)
      if (l > o) {
        if (e.charCodeAt(i + c) === J)
  ...
  extname(t) {
    ...
    for (let l = t.length - 1; l >= 0; --l) {
      ...
      r === -1 && (s = !1, r = l + 1), o === "." ? e === -1 ? e = l : i !== 1 && (i = 1) : e !== -1 && (i = -1);
    }
  ...
  parse(t) {
    ...
    let r;
    n ? (e.root = "/", r = 1) : r = 0;
    let s = -1, i = 0, l = -1, o = !0, u = t.length - 1, c = 0;
    for (; u >= r; --u) {
      ...
      l === -1 && (o = !1, l = u + 1), h === Pe ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
    if (l !== -1) {
      const h = i === 0 && n ? 1 : i;
      s === -1 || // We saw a non-dot character immediately before the dot
      c === 0 || // The (right-most) trimmed path component is exactly '..'
      c === 1 && s === l - 1 && s === i + 1 ? e.base = e.name = t.slice(h, l) : (e.name = t.slice(h, s), e.base = t.slice(h, l), e.ext = t.slice(s, l));
    }
...
re.win32 = K.win32 = K;
re.posix = K.posix = re;
Ae ? K.normalize : re.normalize;
Ae ? K.resolve : re.resolve;
Ae ? K.relative : re.relative;
Ae ? K.dirname : re.dirname;
Ae ? K.basename : re.basename;
Ae ? K.extname : re.extname;
Ae ? K.sep : re.sep;
const ra = /^\w[\w\d+.-]*$/, sa = /^\//, ia = /^\/\//;
function aa(t, e) {
  if (!t.scheme && e)
...
class Fe {
  static isUri(e) {
    return e instanceof Fe ? !0 : !e || typeof e != "object" ? !1 : typeof e.authority == "string" && typeof e.fragment == "string" && typeof e.path == "string" && typeof e.query == "string" && typeof e.scheme == "string" && typeof e.fsPath == "string" && typeof e.with == "function" && typeof e.toString == "function";
  }
  /**
   * @internal
   */
  constructor(e, n, r, s, i, l = !1) {
    typeof e == "object" ? (this.scheme = e.scheme || G, this.authority = e.authority || G, this.path = e.path || G, this.query = e.query || G, this.fragment = e.fragment || G) : (this.scheme = la(e, l), this.authority = n || G, this.path = oa(this.scheme, r || G), this.query = s || G, this.fragment = i || G, aa(this, l));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(e) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = G), r === void 0 ? r = this.authority : r === null && (r = G), s === void 0 ? s = this.path : s === null && (s = G), i === void 0 ? i = this.query : i === null && (i = G), l === void 0 ? l = this.fragment : l === null && (l = G), n === this.scheme && r === this.authority && s === this.path && i === this.query && l === this.fragment ? this : new Be(n, r, s, i, l);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(e, n = !1) {
    const r = ua.exec(e);
    return r ? new Be(r[2] || G, yt(r[4] || G), yt(r[5] || G), yt(r[7] || G), yt(r[9] || G), n) : new Be(G, G, G, G, G);
  }
  /**
  ...
  static file(e) {
    let n = G;
    if (mt && (e = e.replace(/\\/g, he)), e[0] === he && e[1] === he) {
      const r = e.indexOf(he, 2);
      r === -1 ? (n = e.substring(2), e = he) : (n = e.substring(2, r), e = e.substring(r) || he);
    }
    return new Be("file", n, e, G, G);
  }
  /**
   ...
   */
  static from(e, n) {
    return new Be(e.scheme, e.authority, e.path, e.query, e.fragment, n);
  }
  /**
  ...
  static joinPath(e, ...n) {
    ...
    let r;
    return mt && e.scheme === "file" ? r = Fe.file(K.join(on(e, !0), ...n)).path : r = re.join(e.path, ...n), e.with({ path: r });
  }
  ...
  static revive(e) {
    if (e) {
      ...
      {
        const n = new Be(e);
        return n._formatted = e.external ?? null, n._fsPath = e._sep === Ms ? e.fsPath ?? null : null, n;
      }
    } else return e;
  }
}
const Ms = mt ? 1 : void 0;
class Be extends Fe {
  constructor() {
  ...
  toJSON() {
    ...
    return this._fsPath && (e.fsPath = this._fsPath, e._sep = Ms), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e;
  }
}
const ks = {
  58: "%3A",
...
function Bn(t, e, n) {
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    if (l >= 97 && l <= 122 || l >= 65 && l <= 90 || l >= 48 && l <= 57 || l === 45 || l === 46 || l === 95 || l === 126 || e && l === 47 || n && l === 91 || n && l === 93 || n && l === 58)
      s !== -1 && (r += encodeURIComponent(t.substring(s, i)), s = -1), r !== void 0 && (r += t.charAt(i));
    else {
      r === void 0 && (r = t.substr(0, i));
      const o = ks[l];
      o !== void 0 ? (s !== -1 && (r += encodeURIComponent(t.substring(s, i)), s = -1), r += o) : s === -1 && (s = i);
    }
  }
...
function ca(t) {
  ...
  for (let n = 0; n < t.length; n++) {
    const r = t.charCodeAt(n);
    r === 35 || r === 63 ? (e === void 0 && (e = t.substr(0, n)), e += ks[r]) : e !== void 0 && (e += t[n]);
  }
  return e !== void 0 ? e : t;
}
function on(t, e) {
  let n;
  return t.authority && t.path.length > 1 && t.scheme === "file" ? n = `//${t.authority}${t.path}` : t.path.charCodeAt(0) === 47 && (t.path.charCodeAt(1) >= 65 && t.path.charCodeAt(1) <= 90 || t.path.charCodeAt(1) >= 97 && t.path.charCodeAt(1) <= 122) && t.path.charCodeAt(2) === 58 ? e ? n = t.path.substr(1) : n = t.path[1].toLowerCase() + t.path.substr(2) : n = t.path, mt && (n = n.replace(/\//g, "\\")), n;
}
function un(t, e) {
  const n = e ? ca : Bn;
  let r = "", { scheme: s, authority: i, path: l, query: o, fragment: u } = t;
  ...
  return o && (r += "?", r += n(o, !1, !1)), u && (r += "#", r += e ? u : Bn(u, !1, !1)), r;
}
function Ps(t) {
  try {
    return decodeURIComponent(t);
  } catch {
    return t.length > 3 ? t.substr(0, 3) + Ps(t.substr(3)) : t;
  }
}
const qn = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function yt(t) {
  return t.match(qn) ? t.replace(qn, (e) => Ps(e)) : t;
}
class se extends C {
  constructor(e, n, r, s) {
   ...
   */
  setEndPosition(e, n) {
    return this.getDirection() === 0 ? new se(this.startLineNumber, this.startColumn, e, n) : new se(e, n, this.startLineNumber, this.startColumn);
  }
  /**
  ...
  */
   ...
   */
  setStartPosition(e, n) {
    return this.getDirection() === 0 ? new se(e, n, this.endLineNumber, this.endColumn) : new se(this.endLineNumber, this.endColumn, e, n);
  }
  // ----
  /**
  ...
  static fromRange(e, n) {
    return n === 0 ? new se(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn) : new se(e.endLineNumber, e.endColumn, e.startLineNumber, e.startColumn);
  }
  /**
...
class fa {
  ...
  register(e, n) {
    return this._tokenizationSupports.set(e, n), this.handleChange([e]), Rt(() => {
  ...
  registerFactory(e, n) {
    ...
    return this._factories.set(e, r), Rt(() => {
...
(function(t) {
  ...
  e.set(0, k.symbolMethod), e.set(1, k.symbolFunction), e.set(2, k.symbolConstructor), e.set(3, k.symbolField), e.set(4, k.symbolVariable), e.set(5, k.symbolClass), e.set(6, k.symbolStruct), e.set(7, k.symbolInterface), e.set(8, k.symbolModule), e.set(9, k.symbolProperty), e.set(10, k.symbolEvent), e.set(11, k.symbolOperator), e.set(12, k.symbolUnit), e.set(13, k.symbolValue), e.set(15, k.symbolEnum), e.set(14, k.symbolConstant), e.set(15, k.symbolEnum), e.set(16, k.symbolEnumMember), e.set(17, k.symbolKeyword), e.set(28, k.symbolSnippet), e.set(18, k.symbolText), e.set(19, k.symbolColor), e.set(20, k.symbolFile), e.set(21, k.symbolReference), e.set(22, k.symbolCustomColor), e.set(23, k.symbolFolder), e.set(24, k.symbolTypeParameter), e.set(25, k.account), e.set(26, k.issues), e.set(27, k.tools);
  function n(l) {
    let o = e.get(l);
    return o || (console.info("No codicon found for CompletionItemKind " + l), o = k.symbolProperty), o;
  }
  t.toIcon = n;
  function r(l) {
    switch (l) {
      case 0:
        return P(724, "Method");
      case 1:
        return P(725, "Function");
      case 2:
        return P(726, "Constructor");
      case 3:
        return P(727, "Field");
      case 4:
        return P(728, "Variable");
      case 5:
        return P(729, "Class");
      case 6:
        return P(730, "Struct");
      case 7:
        return P(731, "Interface");
      case 8:
        return P(732, "Module");
      case 9:
        return P(733, "Property");
      case 10:
        return P(734, "Event");
      case 11:
        return P(735, "Operator");
      case 12:
        return P(736, "Unit");
      case 13:
        return P(737, "Value");
      case 14:
        return P(738, "Constant");
      case 15:
        return P(739, "Enum");
      case 16:
        return P(740, "Enum Member");
      case 17:
        return P(741, "Keyword");
      case 18:
        return P(742, "Text");
      case 19:
        return P(743, "Color");
      case 20:
        return P(744, "File");
      case 21:
        return P(745, "Reference");
      case 22:
        return P(746, "Custom Color");
      case 23:
        return P(747, "Folder");
      case 24:
        return P(748, "Type Parameter");
      case 25:
        return P(749, "User");
      case 26:
        return P(750, "Issue");
...
(function(t) {
  ...
  function n(i) {
    let l = e.get(i);
    return l || (console.info("No codicon found for SymbolKind " + i), l = k.symbolProperty), l;
  }
  t.toIcon = n;
...
ae.Comment = new ae("comment"), ae.Imports = new ae("imports"), ae.Region = new ae("region");
let Jn = ae;
var Yn;
(function(t) {
...
je.CtrlCmd = 2048, je.Shift = 1024, je.Alt = 512, je.WinCtrl = 256;
let dn = je;
function ba() {
  return {
    editor: void 0,
...
function Sn(t, e, n, r, s) {
  if (e = Ts(e), s || (s = At.first(Ds)), n.length > s.maxLen) {
    let c = t - s.maxLen / 2;
    return c < 0 ? c = 0 : r += c, n = n.substring(c, t + s.maxLen / 2), Sn(t, e, n, r, s);
  }
  const i = Date.now(), l = t - 1 - r;
  let o = -1, u = null;
...
class Ea {
  static computeUnicodeHighlights(e, n, r) {
    const s = r ? r.startLineNumber : 1, i = r ? r.endLineNumber : e.getLineCount(), l = new Jr(n), o = l.getCandidateCodePoints();
    let u;
    o === "allNonBasicAscii" ? u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : u = new RegExp(`${Ma(Array.from(o))}`, "g");
    const c = new Sa(null, u), h = [];
    let m = !1, f, p = 0, g = 0, d = 0;
    e: for (let y = s, N = i; y <= N; y++) {
      const v = e.getLineContent(y), L = v.length;
      c.reset(0);
      do
        if (f = c.next(v), f) {
          let E = f.index, T = f.index + f[0].length;
          if (E > 0) {
          ...
          const I = v.substring(E, T);
          let w = Sn(E + 1, Fs, v, 0);
          w && w.endColumn <= E + 1 && (w = null);
          const _ = l.shouldHighlightNonBasicASCII(I, w ? w.word : null);
          if (_ !== 0) {
            if (_ === 3 ? p++ : _ === 2 ? g++ : _ === 1 ? d++ : Gs(), h.length >= 1e3) {
              m = !0;
              break e;
            }
            h.push(new C(y, E + 1, y, T + 1));
          }
        }
      while (f);
    }
  ...
  static computeUnicodeHighlightReason(e, n) {
    ...
    switch (r.shouldHighlightNonBasicASCII(e, null)) {
      ...
      case 3: {
        const i = e.codePointAt(0), l = r.ambiguousCharacters.getPrimaryConfusable(i), o = ft.getLocales().filter((u) => !ft.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, u])).isAmbiguous(i));
...
class Jr {
  constructor(e) {
    this.options = e, this.allowedCodePoints = new Set(e.allowedCodePoints), this.ambiguousCharacters = ft.getInstance(new Set(e.allowedLocales));
  }
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of it.codePoints)
        Yr(String.fromCodePoint(n)) || e.add(n);
  ...
  shouldHighlightNonBasicASCII(e, n) {
    ...
    if (n)
      for (const l of n) {
        ...
        s = s || u, !u && !this.ambiguousCharacters.isAmbiguous(o) && !it.isInvisibleCharacter(o) && (i = !0);
      }
    return (
      /* Don't allow mixing weird looking characters with ASCII */
      !s && /* Is there an obviously weird looking character? */
      i ? 0 : this.options.invisibleCharacters && !Yr(e) && it.isInvisibleCharacter(r) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(r) ? 3 : 0
    );
  }
}
function Yr(t) {
...
const Oe = class Oe {
  ...
  filter(e) {
    return new Oe((n) => this.iterate((r) => e(r) ? n(r) : !0));
  }
  map(e) {
    return new Oe((n) => this.iterate((r) => n(e(r))));
  }
  findLast(e) {
    let n;
...
class U {
  ...
  static addRange(e, n) {
    ...
    if (r === s)
      ...
      const i = Math.min(e.start, n[r].start), l = Math.max(e.endExclusive, n[s - 1].endExclusive);
  ...
  */
  joinRightTouching(e) {
    ...
    return new U(this.start, e.endExclusive);
  }
}
function Ze(t, e) {
  const n = Ke(t, e);
...
function bn(t, e, n = 0, r = t.length) {
  let s = n, i = r;
  for (; s < i; ) {
    const l = Math.floor((s + i) / 2);
    e(t[l]) ? i = l : s = l + 1;
...
const ie = class ie {
   ...
   */
  join(e) {
    return new ie(Math.min(this.startLineNumber, e.startLineNumber), Math.max(this.endLineNumberExclusive, e.endLineNumberExclusive));
  }
  toString() {
    return `[${this.startLineNumber},${this.endLineNumberExclusive})`;
  }
  ...
  toInclusiveRange() {
    return this.isEmpty ? null : new C(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER);
  }
  /**
...
class de {
  ...
  addRange(e) {
    if (e.length === 0)
      return;
    const n = bn(this._normalizedRanges, (s) => s.endLineNumberExclusive >= e.startLineNumber), r = Ke(this._normalizedRanges, (s) => s.startLineNumber <= e.endLineNumberExclusive) + 1;
    if (n === r)
  ...
  getUnion(e) {
    ...
    for (; r < this._normalizedRanges.length || s < e._normalizedRanges.length; ) {
      ...
      if (r < this._normalizedRanges.length && s < e._normalizedRanges.length) {
        const o = this._normalizedRanges[r], u = e._normalizedRanges[s];
        o.startLineNumber < u.startLineNumber ? (l = o, r++) : (l = u, s++);
      } else r < this._normalizedRanges.length ? (l = this._normalizedRanges[r], r++) : (l = e._normalizedRanges[s], s++);
      i === null ? i = l : i.endLineNumberExclusive >= l.startLineNumber ? i = new $(i.startLineNumber, Math.max(i.endLineNumberExclusive, l.endLineNumberExclusive)) : (n.push(i), i = l);
    }
   ...
   */
  subtractFrom(e) {
    const n = bn(this._normalizedRanges, (l) => l.endLineNumberExclusive >= e.startLineNumber), r = Ke(this._normalizedRanges, (l) => l.startLineNumber <= e.endLineNumberExclusive) + 1;
    if (n === r)
      return new de([e]);
    const s = [];
  ...
  getIntersection(e) {
    ...
    let r = 0, s = 0;
    for (; r < this._normalizedRanges.length && s < e._normalizedRanges.length; ) {
      const i = this._normalizedRanges[r], l = e._normalizedRanges[s], o = i.intersect(l);
...
const ce = class ce {
  static betweenPositions(e, n) {
    return e.lineNumber === n.lineNumber ? new ce(0, n.column - e.column) : new ce(n.lineNumber - e.lineNumber, n.column - 1);
  }
...
` ? (n++, r = 0) : r++;
  ...
  add(e) {
    return e.lineCount === 0 ? new ce(this.lineCount, this.columnCount + e.columnCount) : new ce(this.lineCount + e.lineCount, e.columnCount);
  }
  createRange(e) {
    return this.lineCount === 0 ? new C(e.lineNumber, e.column, e.lineNumber, e.column + this.columnCount) : new C(e.lineNumber, e.column, e.lineNumber + this.lineCount, this.columnCount + 1);
  }
  toRange() {
  ...
  addToPosition(e) {
    return this.lineCount === 0 ? new H(e.lineNumber, e.column + this.columnCount) : new H(e.lineNumber + this.lineCount, this.columnCount + 1);
  }
  toString() {
...
class qa {
  getOffsetRange(e) {
    return new U(this.getOffset(e.getStartPosition()), this.getOffset(e.getEndPosition()));
  }
  getRange(e) {
...
class Ha extends $a {
  constructor(e, n) {
    js(n >= 1), super(), this._getLineContent = e, this._lineCount = n;
  }
  getValueOfRange(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1), n;
  ...
  get length() {
    ...
    return new dt(this._lineCount - 1, e.length);
  }
}
class xt extends Ha {
  constructor(e) {
  ...
  static joinReplacements(e, n) {
    ...
    for (let l = 0; l < e.length; l++) {
      ...
      if (i += o.text, l < e.length - 1) {
        const u = e[l + 1], c = C.fromPositions(o.range.getEndPosition(), u.range.getStartPosition()), h = n.getValueOfRange(c);
        i += h;
      }
    }
    return new ve(C.fromPositions(r, s), i);
  }
  static fromStringReplacement(e, n) {
    return new ve(n.getTransformer().getRange(e.replaceRange), e.newText);
  }
  static delete(e) {
    return new ve(e, "");
  }
...
`, `
`), s = xi(n, r), i = dt.ofText(n.substring(0, s)).addToPosition(this.range.getStartPosition()), l = r.substring(s), o = C.fromPositions(i, this.range.getEndPosition());
    return new ve(o, l);
  }
...
`), r = this.text.replaceAll(`\r
`, `
`), s = _i(n, r), i = dt.ofText(n.substring(0, n.length - s)).addToPosition(this.range.getStartPosition()), l = r.substring(0, r.length - s), o = C.fromPositions(this.range.getStartPosition(), i);
    return new ve(o, l);
  }
  toString() {
...
class ue {
  static inverse(e, n, r) {
    ...
    let i = 1, l = 1;
    for (const u of e) {
      const c = new ue(new $(i, u.original.startLineNumber), new $(l, u.modified.startLineNumber));
      c.modified.isEmpty || s.push(c), i = u.original.endLineNumberExclusive, l = u.modified.endLineNumberExclusive;
    }
    const o = new ue(new $(i, n + 1), new $(l, r + 1));
  ...
  static clip(e, n, r) {
    ...
    for (const i of e) {
      ...
      l && !l.isEmpty && o && !o.isEmpty && s.push(new ue(l, o));
    }
    return s;
  }
  constructor(e, n) {
  ...
  flip() {
    return new ue(this.modified, this.original);
  }
  join(e) {
    return new ue(this.original.join(e.original), this.modified.join(e.modified));
  }
  /**
  ...
  */
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new le(new C(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new C(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new le(new C(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new C(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
  }
  /**
   * This method assumes that the LineRangeMapping describes a valid diff!
   * I.e. if one range is empty, the other range cannot be the entire document.
  ...
  */
  toRangeMapping2(e, n) {
    if (Kr(this.original.endLineNumberExclusive, e) && Kr(this.modified.endLineNumberExclusive, n))
      return new le(new C(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new C(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new le(C.fromPositions(new H(this.original.startLineNumber, 1), qe(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), C.fromPositions(new H(this.modified.startLineNumber, 1), qe(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new le(C.fromPositions(qe(new H(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e), qe(new H(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), C.fromPositions(qe(new H(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), qe(new H(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new Y();
  }
}
function qe(t, e) {
...
class xe extends ue {
  static fromRangeMappings(e) {
    const n = $.join(e.map((s) => $.fromRangeInclusive(s.originalRange))), r = $.join(e.map((s) => $.fromRangeInclusive(s.modifiedRange)));
    return new xe(n, r, e);
  }
  constructor(e, n, r) {
  ...
  flip() {
    return new xe(this.modified, this.original, this.innerChanges?.map((e) => e.flip()));
  }
...
function es(t, e, n, r = !1) {
  const s = [];
  for (const i of Fa(t.map((l) => Wa(l, e, n)), (l, o) => l.original.intersectsOrTouches(o.original) || l.modified.intersectsOrTouches(o.modified))) {
    const l = i[0], o = i[i.length - 1];
    s.push(new xe(l.original.join(o.original), l.modified.join(o.modified), i.map((u) => u.innerChanges[0])));
  }
  return St(() => !r && s.length > 0 && (s[0].modified.startLineNumber !== s[0].original.startLineNumber || n.length.lineCount - s[s.length - 1].modified.endLineNumberExclusive !== e.length.lineCount - s[s.length - 1].original.endLineNumberExclusive) ? !1 : _s(s, (i, l) => l.original.startLineNumber - i.original.endLineNumberExclusive === l.modified.startLineNumber - i.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
...
function Wa(t, e, n) {
  ...
  const i = new $(t.originalRange.startLineNumber + r, t.originalRange.endLineNumber + 1 + s), l = new $(t.modifiedRange.startLineNumber + r, t.modifiedRange.endLineNumber + 1 + s);
  return new xe(i, l, [t]);
}
const za = 3;
class Ga {
  computeDiff(e, n, r) {
    ...
    for (const u of i.changes) {
      let c;
      u.originalEndLineNumber === 0 ? c = new $(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1) : c = new $(u.originalStartLineNumber, u.originalEndLineNumber + 1);
      let h;
      u.modifiedEndLineNumber === 0 ? h = new $(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1) : h = new $(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1);
      let m = new xe(c, h, u.charChanges?.map((f) => new le(new C(f.originalStartLineNumber, f.originalStartColumn, f.originalEndLineNumber, f.originalEndColumn), new C(f.modifiedStartLineNumber, f.modifiedStartColumn, f.modifiedEndLineNumber, f.modifiedEndColumn))));
      o && (o.modified.endLineNumberExclusive === m.modified.startLineNumber || o.original.endLineNumberExclusive === m.original.startLineNumber) && (m = new xe(o.original.join(m.original), o.modified.join(m.modified), o.innerChanges && m.innerChanges ? o.innerChanges.concat(m.innerChanges) : void 0), l.pop()), l.push(m), o = m;
    }
    return St(() => _s(l, (u, c) => c.original.startLineNumber - u.original.endLineNumberExclusive === c.modified.startLineNumber - u.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    u.original.endLineNumberExclusive < c.original.startLineNumber && u.modified.endLineNumberExclusive < c.modified.startLineNumber)), new Nt(l, [], i.quitEarly);
  }
}
function Vs(t, e, n, r) {
  return new Ne(t, e, n).ComputeDiff(r);
}
let ts = class {
  constructor(e) {
    const n = [], r = [];
    for (let s = 0, i = e.length; s < i; s++)
      n[s] = pn(e[s], 1), r[s] = wn(e[s], 1);
  ...
  createCharSequence(e, n, r) {
    ...
    let o = 0;
    for (let u = n; u <= r; u++) {
      const c = this.lines[u], h = e ? this._startColumns[u] : 1, m = e ? this._endColumns[u] : c.length + 1;
      for (let f = h; f < m; f++)
        s[o] = c.charCodeAt(f - 1), i[o] = u + 1, l[o] = f, o++;
...
class Je {
  constructor(e, n, r, s, i, l, o, u) {
    this.originalStartLineNumber = e, this.originalStartColumn = n, this.originalEndLineNumber = r, this.originalEndColumn = s, this.modifiedStartLineNumber = i, this.modifiedStartColumn = l, this.modifiedEndLineNumber = o, this.modifiedEndColumn = u;
  }
  static createFromDiffChange(e, n, r) {
    const s = n.getStartLineNumber(e.originalStart), i = n.getStartColumn(e.originalStart), l = n.getEndLineNumber(e.originalStart + e.originalLength - 1), o = n.getEndColumn(e.originalStart + e.originalLength - 1), u = r.getStartLineNumber(e.modifiedStart), c = r.getStartColumn(e.modifiedStart), h = r.getEndLineNumber(e.modifiedStart + e.modifiedLength - 1), m = r.getEndColumn(e.modifiedStart + e.modifiedLength - 1);
    return new Je(s, i, l, o, u, c, h, m);
  }
}
function Oa(t) {
  if (t.length <= 1)
  ...
  for (let r = 1, s = t.length; r < s; r++) {
    const i = t[r], l = i.originalStart - (n.originalStart + n.originalLength), o = i.modifiedStart - (n.modifiedStart + n.modifiedLength);
    Math.min(l, o) < za ? (n.originalLength = i.originalStart + i.originalLength - n.originalStart, n.modifiedLength = i.modifiedStart + i.modifiedLength - n.modifiedStart) : (e.push(i), n = i);
  }
  return e;
}
class ot {
  ...
  static createFromDiffResult(e, n, r, s, i, l, o) {
    ...
    if (n.originalLength === 0 ? (u = r.getStartLineNumber(n.originalStart) - 1, c = 0) : (u = r.getStartLineNumber(n.originalStart), c = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = s.getStartLineNumber(n.modifiedStart) - 1, m = 0) : (h = s.getStartLineNumber(n.modifiedStart), m = s.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), l && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && i()) {
      const p = r.createCharSequence(e, n.originalStart, n.originalStart + n.originalLength - 1), g = s.createCharSequence(e, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
      if (p.getElements().length > 0 && g.getElements().length > 0) {
        let d = Vs(p, g, i, !0).changes;
        o && (d = Oa(d)), f = [];
        for (let y = 0, N = d.length; y < N; y++)
          f.push(Je.createFromDiffChange(d[y], p, g));
      }
    }
    return new ot(u, c, h, m, f);
  }
}
class Xa {
  constructor(e, n, r) {
  ...
  computeDiff() {
    ...
    const e = Vs(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = e.changes, r = e.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const o = [];
      for (let u = 0, c = n.length; u < c; u++)
        o.push(ot.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[u], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: r,
        changes: o
      };
    ...
    for (let o = -1, u = n.length; o < u; o++) {
      const c = o + 1 < u ? n[o + 1] : null, h = c ? c.originalStart : this.originalLines.length, m = c ? c.modifiedStart : this.modifiedLines.length;
      for (; i < h && l < m; ) {
        const f = this.originalLines[i], p = this.modifiedLines[l];
        if (f !== p) {
          {
            let g = pn(f, 1), d = pn(p, 1);
            for (; g > 1 && d > 1; ) {
              const y = f.charCodeAt(g - 2), N = p.charCodeAt(d - 2);
              if (y !== N)
                break;
              g--, d--;
            }
          ...
          {
            let g = wn(f, 1), d = wn(p, 1);
            const y = f.length + 1, N = p.length + 1;
            for (; g < y && d < N; ) {
              const v = f.charCodeAt(g - 1), L = f.charCodeAt(d - 1);
              if (v !== L)
                break;
              g++, d++;
            }
            (g < y || d < N) && this._pushTrimWhitespaceCharChange(s, i + 1, g, y, l + 1, d, N);
          }
        }
        i++, l++;
      }
      c && (s.push(ot.createFromDiffResult(this.shouldIgnoreTrimWhitespace, c, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += c.originalLength, l += c.modifiedLength);
    }
    return {
      quitEarly: r,
      changes: s
  ...
  _pushTrimWhitespaceCharChange(e, n, r, s, i, l, o) {
    if (this._mergeTrimWhitespaceCharChange(e, n, r, s, i, l, o))
      return;
    let u;
    this.shouldComputeCharChanges && (u = [new Je(n, r, n, s, i, l, i, o)]), e.push(new ot(n, n, i, i, u));
  }
...
class _e {
  static trivial(e, n) {
    return new _e([new O(U.ofLength(e.length), U.ofLength(n.length))], !1);
  }
  static trivialTimedOut(e, n) {
    return new _e([new O(U.ofLength(e.length), U.ofLength(n.length))], !0);
  }
  constructor(e, n) {
...
class O {
  static invert(e, n) {
    const r = [];
    return Ta(e, (s, i) => {
      r.push(O.fromOffsetPairs(s ? s.getEndExclusives() : ye.zero, i ? i.getStarts() : new ye(n, (s ? s.seq2Range.endExclusive - s.seq1Range.endExclusive : 0) + n)));
    }), r;
  }
  static fromOffsetPairs(e, n) {
    return new O(new U(e.offset1, n.offset1), new U(e.offset2, n.offset2));
  }
  static assertSorted(e) {
    let n;
    for (const r of e) {
...
const Ee = class Ee {
  ...
  delta(e) {
    return e === 0 ? this : new Ee(this.offset1 + e, this.offset2 + e);
  }
  equals(e) {
    return this.offset1 === e.offset1 && this.offset2 === e.offset2;
  }
};
Ee.zero = new Ee(0, 0), Ee.max = new Ee(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
let ye = Ee;
const qt = class qt {
  isValid() {
    return !0;
...
let Ft = ut;
class Ja {
  compute(e, n, r = gt.instance, s) {
    if (e.length === 0 || n.length === 0)
      return _e.trivial(e, n);
    const i = new Ot(e.length, n.length), l = new Ot(e.length, n.length), o = new Ot(e.length, n.length);
    for (let g = 0; g < e.length; g++)
      for (let d = 0; d < n.length; d++) {
        if (!r.isValid())
          return _e.trivialTimedOut(e, n);
        const y = g === 0 ? 0 : i.get(g - 1, d), N = d === 0 ? 0 : i.get(g, d - 1);
        let v;
        e.getElement(g) === n.getElement(d) ? (g === 0 || d === 0 ? v = 0 : v = i.get(g - 1, d - 1), g > 0 && d > 0 && l.get(g - 1, d - 1) === 3 && (v += o.get(g - 1, d - 1)), v += s ? s(g, d) : 1) : v = -1;
        const L = Math.max(y, N, v);
        if (L === v) {
          const E = g > 0 && d > 0 ? o.get(g - 1, d - 1) : 0;
          o.set(g, d, E + 1), l.set(g, d, 3);
        } else L === y ? (o.set(g, d, 0), l.set(g, d, 1)) : L === N && (o.set(g, d, 0), l.set(g, d, 2));
        i.set(g, d, L);
      }
    const u = [];
    let c = e.length, h = n.length;
    function m(g, d) {
      (g + 1 !== c || d + 1 !== h) && u.push(new O(new U(g + 1, c), new U(d + 1, h))), c = g, h = d;
    }
    let f = e.length - 1, p = n.length - 1;
    for (; f >= 0 && p >= 0; )
      l.get(f, p) === 3 ? (m(f, p), f--, p--) : l.get(f, p) === 1 ? f-- : p--;
    return m(-1, -1), u.reverse(), new _e(u, !1);
  }
}
class Is {
  compute(e, n, r = gt.instance) {
    ...
    const s = e, i = n;
    function l(d, y) {
      for (; d < s.length && y < i.length && s.getElement(d) === i.getElement(y); )
        d++, y++;
      return d;
    }
    let o = 0;
    ...
    e: for (; ; ) {
      if (o++, !r.isValid())
        return _e.trivialTimedOut(s, i);
      const d = -Math.min(o, i.length + o % 2), y = Math.min(o, s.length + o % 2);
      for (h = d; h <= y; h += 2) {
        const N = h === y ? -1 : u.get(h + 1), v = h === d ? -1 : u.get(h - 1) + 1, L = Math.min(Math.max(N, v), s.length), E = L - h;
        if (L > s.length || E > i.length)
          continue;
        const T = l(L, E);
        u.set(h, T);
        const I = L === N ? c.get(h + 1) : c.get(h - 1);
        if (c.set(h, T !== L ? new rs(I, L, E, T - L) : I), u.get(h) === s.length && u.get(h) - h === i.length)
          break e;
      }
    }
    let m = c.get(h);
    const f = [];
    let p = s.length, g = i.length;
    for (; ; ) {
      const d = m ? m.x + m.length : 0, y = m ? m.y + m.length : 0;
      if ((d !== p || y !== g) && f.push(new O(new U(d, p), new U(y, g))), !m)
        break;
      p = m.x, g = m.y, m = m.prev;
    }
    return f.reverse(), new _e(f, !1);
  }
}
class rs {
  constructor(e, n, r, s) {
...
class Tt {
  constructor(e, n, r) {
    ...
    for (let s = this.range.startLineNumber; s <= this.range.endLineNumber; s++) {
      let i = e[s - 1], l = 0;
      s === this.range.startLineNumber && this.range.startColumn > 1 && (l = this.range.startColumn - 1, i = i.substring(l)), this.lineStartOffsets.push(l);
      let o = 0;
      if (!r) {
        const c = i.trimStart();
  ...
  translateOffset(e, n = "right") {
    ...
    return new H(this.range.startLineNumber + r, 1 + this.lineStartOffsets[r] + s + (s === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[r]));
  }
  translateRange(e) {
  ...
  findWordContaining(e) {
    if (e < 0 || e >= this.elements.length || !Ue(this.elements[e]))
      return;
    let n = e;
    for (; n > 0 && Ue(this.elements[n - 1]); )
      n--;
    let r = e;
    for (; r < this.elements.length && Ue(this.elements[r]); )
      r++;
    return new U(n, r);
  }
  ...
  findSubWordContaining(e) {
    if (e < 0 || e >= this.elements.length || !Ue(this.elements[e]))
      return;
    let n = e;
    for (; n > 0 && Ue(this.elements[n - 1]) && !ss(this.elements[n]); )
      n--;
    let r = e;
    for (; r < this.elements.length && Ue(this.elements[r]) && !ss(this.elements[r]); )
      r++;
    return new U(n, r);
  }
  countLinesIn(e) {
  ...
  extendToFullLines(e) {
    const n = Ze(this.firstElementOffsetByLineIdx, (s) => s <= e.start) ?? 0, r = Ba(this.firstElementOffsetByLineIdx, (s) => e.endExclusive <= s) ?? this.elements.length;
    return new U(n, r);
  }
}
function Ue(t) {
...
function e1(t, e, n, r, s, i) {
  ...
  if (!i.isValid())
    return [];
  const u = t.filter((h) => !o.has(h)), c = r1(u, r, s, e, n, i);
  return Va(l, c), l = s1(l), l = l.filter((h) => {
    const m = h.original.toOffsetRange().slice(e).map((p) => p.trim());
    return m.join(`
`).length >= 15 && t1(m, (p) => p.length >= 2) >= 2;
  }), l = i1(t, l), l;
}
function t1(t, e) {
  let n = 0;
...
function n1(t, e, n, r) {
  const s = [], i = t.filter((u) => u.modified.isEmpty && u.original.length >= 3).map((u) => new Ft(u.original, e, u)), l = new Set(t.filter((u) => u.original.isEmpty && u.modified.length >= 3).map((u) => new Ft(u.modified, n, u))), o = /* @__PURE__ */ new Set();
  for (const u of i) {
    let c = -1, h;
    for (const m of l) {
    ...
    if (c > 0.9 && h && (l.delete(h), s.push(new ue(u.range, h.range)), o.add(u.source), o.add(h.source)), !r.isValid())
...
function r1(t, e, n, r, s, i) {
  ...
  const u = [];
  t.sort(at((f) => f.modified.startLineNumber, lt));
  for (const f of t) {
    let p = [];
    for (let g = f.modified.startLineNumber; g < f.modified.endLineNumberExclusive - 2; g++) {
      const d = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`, y = new $(g, g + 3), N = [];
      o.forEach(d, ({ range: v }) => {
        for (const E of p)
          if (E.originalLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive && E.modifiedLineRange.endLineNumberExclusive + 1 === y.endLineNumberExclusive) {
            E.originalLineRange = new $(E.originalLineRange.startLineNumber, v.endLineNumberExclusive), E.modifiedLineRange = new $(E.modifiedLineRange.startLineNumber, y.endLineNumberExclusive), N.push(E);
            return;
          }
        const L = {
          modifiedLineRange: y,
  ...
  u.sort(Ia(at((f) => f.modifiedLineRange.length, lt)));
  const c = new de(), h = new de();
  for (const f of u) {
    const p = f.modifiedLineRange.startLineNumber - f.originalLineRange.startLineNumber, g = c.subtractFrom(f.modifiedLineRange), d = h.subtractFrom(f.originalLineRange).getWithDelta(p), y = g.getIntersection(d);
    for (const N of y.ranges) {
      if (N.length < 3)
        continue;
      const v = N, L = N.delta(-p);
      l.push(new ue(L, v)), c.addRange(v), h.addRange(L);
    }
  }
  l.sort(at((f) => f.original.startLineNumber, lt));
  const m = new Pt(t);
  for (let f = 0; f < l.length; f++) {
    const p = l[f], g = m.findLastMonotonous((I) => I.original.startLineNumber <= p.original.startLineNumber), d = Ze(t, (I) => I.modified.startLineNumber <= p.modified.startLineNumber), y = Math.max(p.original.startLineNumber - g.original.startLineNumber, p.modified.startLineNumber - d.modified.startLineNumber), N = m.findLastMonotonous((I) => I.original.startLineNumber < p.original.endLineNumberExclusive), v = Ze(t, (I) => I.modified.startLineNumber < p.modified.endLineNumberExclusive), L = Math.max(N.original.endLineNumberExclusive - p.original.endLineNumberExclusive, v.modified.endLineNumberExclusive - p.modified.endLineNumberExclusive);
    let E;
    for (E = 0; E < y; E++) {
      const I = p.original.startLineNumber - E - 1, w = p.modified.startLineNumber - E - 1;
      if (I > r.length || w > s.length || c.contains(w) || h.contains(I) || !ls(r[I - 1], s[w - 1], i))
        break;
    }
    E > 0 && (h.addRange(new $(p.original.startLineNumber - E, p.original.startLineNumber)), c.addRange(new $(p.modified.startLineNumber - E, p.modified.startLineNumber)));
    let T;
    for (T = 0; T < L; T++) {
      const I = p.original.endLineNumberExclusive + T, w = p.modified.endLineNumberExclusive + T;
      if (I > r.length || w > s.length || c.contains(w) || h.contains(I) || !ls(r[I - 1], s[w - 1], i))
        break;
    }
    T > 0 && (h.addRange(new $(p.original.endLineNumberExclusive, p.original.endLineNumberExclusive + T)), c.addRange(new $(p.modified.endLineNumberExclusive, p.modified.endLineNumberExclusive + T))), (E > 0 || T > 0) && (l[f] = new ue(new $(p.original.startLineNumber - E, p.original.endLineNumberExclusive + T), new $(p.modified.startLineNumber - E, p.modified.endLineNumberExclusive + T)));
  }
  return l;
}
function ls(t, e, n) {
  ...
  if (t.length > 300 && e.length > 300)
    return !1;
  const s = new Is().compute(new Tt([t], new C(1, 1, 1, t.length), !1), new Tt([e], new C(1, 1, 1, e.length), !1), n);
  let i = 0;
...
function s1(t) {
  ...
  for (let n = 1; n < t.length; n++) {
    const r = e[e.length - 1], s = t[n], i = s.original.startLineNumber - r.original.endLineNumberExclusive, l = s.modified.startLineNumber - r.modified.endLineNumberExclusive;
    if (i >= 0 && l >= 0 && i + l <= 2) {
...
function i1(t, e) {
  const n = new Pt(t);
  return e = e.filter((r) => {
    const s = n.findLastMonotonous((o) => o.original.startLineNumber < r.original.endLineNumberExclusive) || new ue(new $(1, 1), new $(1, 1)), i = Ze(t, (o) => o.modified.startLineNumber < r.modified.endLineNumberExclusive);
    return s !== i;
  }), e;
}
function os(t, e, n) {
  let r = n;
  return r = us(t, e, r), r = us(t, e, r), r = a1(t, e, r), r;
}
function us(t, e, n) {
  if (n.length === 0)
    return n;
  ...
  for (let i = 1; i < n.length; i++) {
    ...
    if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
      ...
      let c;
      for (c = 1; c <= u && !(t.getElement(o.seq1Range.start - c) !== t.getElement(o.seq1Range.endExclusive - c) || e.getElement(o.seq2Range.start - c) !== e.getElement(o.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === u) {
        r[r.length - 1] = new O(new U(l.seq1Range.start, o.seq1Range.endExclusive - u), new U(l.seq2Range.start, o.seq2Range.endExclusive - u));
        continue;
      }
      o = o.delta(-c);
    }
  ...
  for (let i = 0; i < r.length - 1; i++) {
    ...
    if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
      ...
      let c;
      for (c = 0; c < u && !(!t.isStronglyEqual(o.seq1Range.start + c, o.seq1Range.endExclusive + c) || !e.isStronglyEqual(o.seq2Range.start + c, o.seq2Range.endExclusive + c)); c++)
        ;
      if (c === u) {
        r[i + 1] = new O(new U(o.seq1Range.start + u, l.seq1Range.endExclusive), new U(o.seq2Range.start + u, l.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (o = o.delta(c));
    }
...
function a1(t, e, n) {
  ...
  for (let r = 0; r < n.length; r++) {
    const s = r > 0 ? n[r - 1] : void 0, i = n[r], l = r + 1 < n.length ? n[r + 1] : void 0, o = new U(s ? s.seq1Range.endExclusive + 1 : 0, l ? l.seq1Range.start - 1 : t.length), u = new U(s ? s.seq2Range.endExclusive + 1 : 0, l ? l.seq2Range.start - 1 : e.length);
    i.seq1Range.isEmpty ? n[r] = cs(i, t, e, o, u) : i.seq2Range.isEmpty && (n[r] = cs(i.swap(), e, t, u, o).swap());
  }
  return n;
}
function cs(t, e, n, r, s) {
  let l = 1;
  for (; t.seq1Range.start - l >= r.start && t.seq2Range.start - l >= s.start && n.isStronglyEqual(t.seq2Range.start - l, t.seq2Range.endExclusive - l) && l < 100; )
    l++;
  l--;
  let o = 0;
  for (; t.seq1Range.start + o < r.endExclusive && t.seq2Range.endExclusive + o < s.endExclusive && n.isStronglyEqual(t.seq2Range.start + o, t.seq2Range.endExclusive + o) && o < 100; )
    o++;
  if (l === 0 && o === 0)
    return t;
  let u = 0, c = -1;
  for (let h = -l; h <= o; h++) {
    const m = t.seq2Range.start + h, f = t.seq2Range.endExclusive + h, p = t.seq1Range.start + h, g = e.getBoundaryScore(p) + n.getBoundaryScore(m) + n.getBoundaryScore(f);
    g > c && (c = g, u = h);
  }
  return t.delta(u);
}
...
function hs(t, e, n, r, s = !1) {
  const i = O.invert(n, t.length), l = [];
  let o = new ye(0, 0);
  function u(h, m) {
    if (h.offset1 < o.offset1 || h.offset2 < o.offset2)
      return;
    const f = r(t, h.offset1), p = r(e, h.offset2);
    if (!f || !p)
      return;
    let g = new O(f, p);
    const d = g.intersect(m);
    let y = d.seq1Range.length, N = d.seq2Range.length;
    for (; i.length > 0; ) {
      const v = i[0];
      if (!(v.seq1Range.intersects(g.seq1Range) || v.seq2Range.intersects(g.seq2Range)))
        break;
      const E = r(t, v.seq1Range.start), T = r(e, v.seq2Range.start), I = new O(E, T), w = I.intersect(v);
      if (y += w.seq1Range.length, N += w.seq2Range.length, g = g.join(I), g.seq1Range.endExclusive >= v.seq1Range.endExclusive)
        i.shift();
      else
        break;
    }
    (s && y + N < g.seq1Range.length + g.seq2Range.length || y + N < (g.seq1Range.length + g.seq2Range.length) * 2 / 3) && l.push(g), o = g.getEndExclusives();
  }
  for (; i.length > 0; ) {
    const h = i.shift();
...
function u1(t, e, n) {
  ...
  do {
    ...
    for (let u = 1; u < r.length; u++) {
      let m = function(p, g) {
        const d = new U(h.seq1Range.endExclusive, c.seq1Range.start);
        return t.getText(d).replace(/\s/g, "").length <= 4 && (p.seq1Range.length + p.seq2Range.length > 5 || g.seq1Range.length + g.seq2Range.length > 5);
      };
      var l = m;
      const c = r[u], h = o[o.length - 1];
      m(h, c) ? (i = !0, o[o.length - 1] = o[o.length - 1].join(c)) : o.push(c);
    }
    r = o;
  } while (s++ < 10 && i);
  return r;
...
function c1(t, e, n) {
  ...
  do {
    ...
    for (let c = 1; c < r.length; c++) {
      let f = function(g, d) {
        const y = new U(m.seq1Range.endExclusive, h.seq1Range.start);
        if (t.countLinesIn(y) > 5 || y.length > 500)
          return !1;
        const v = t.getText(y).trim();
        if (v.length > 20 || v.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const L = t.countLinesIn(g.seq1Range), E = g.seq1Range.length, T = e.countLinesIn(g.seq2Range), I = g.seq2Range.length, w = t.countLinesIn(d.seq1Range), _ = d.seq1Range.length, A = e.countLinesIn(d.seq2Range), D = d.seq2Range.length, B = 130;
        function x(S) {
          return Math.min(S, B);
        }
        return Math.pow(Math.pow(x(L * 40 + E), 1.5) + Math.pow(x(T * 40 + I), 1.5), 1.5) + Math.pow(Math.pow(x(w * 40 + _), 1.5) + Math.pow(x(A * 40 + D), 1.5), 1.5) > (B ** 1.5) ** 1.5 * 1.3;
      };
      var o = f;
      const h = r[c], m = u[u.length - 1];
      f(m, h) ? (i = !0, u[u.length - 1] = u[u.length - 1].join(h)) : u.push(h);
    }
    r = u;
  } while (s++ < 10 && i);
  const l = [];
  return Da(r, (u, c, h) => {
    ...
    const p = t.extendToFullLines(c.seq1Range), g = t.getText(new U(p.start, c.seq1Range.start));
    f(g) && (m = m.deltaStart(-g.length));
    const d = t.getText(new U(c.seq1Range.endExclusive, p.endExclusive));
    f(d) && (m = m.deltaEnd(d.length));
    const y = O.fromOffsetPairs(u ? u.getEndExclusives() : ye.zero, h ? h.getStarts() : ye.max), N = m.intersect(y);
...
class h1 {
  constructor() {
    this.dynamicProgrammingDiffing = new Ja(), this.myersDiffingAlgorithm = new Is();
  }
  computeDiff(e, n, r) {
    if (e.length <= 1 && Pa(e, n, (w, _) => w === _))
      return new Nt([], [], !1);
    if (e.length === 1 && e[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new Nt([
        new xe(new $(1, e.length + 1), new $(1, n.length + 1), [
          new le(new C(1, 1, e.length, e[e.length - 1].length + 1), new C(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const s = r.maxComputationTimeMs === 0 ? gt.instance : new Qa(r.maxComputationTimeMs), i = !r.ignoreTrimWhitespace, l = /* @__PURE__ */ new Map();
    function o(w) {
      let _ = l.get(w);
      return _ === void 0 && (_ = l.size, l.set(w, _)), _;
    }
    const u = e.map((w) => o(w.trim())), c = n.map((w) => o(w.trim())), h = new ms(u, e), m = new ms(c, n), f = h.length + m.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, m, s, (w, _) => e[w] === n[_] ? n[_].length === 0 ? 0.1 : 1 + Math.log(1 + n[_].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, m, s);
    let p = f.diffs, g = f.hitTimeout;
    p = os(h, m, p), p = u1(h, m, p);
    const d = [], y = (w) => {
      if (i)
        for (let _ = 0; _ < w; _++) {
          const A = N + _, D = v + _;
          if (e[A] !== n[D]) {
            const B = this.refineDiff(e, n, new O(new U(A, A + 1), new U(D, D + 1)), s, i, r);
    ...
    let N = 0, v = 0;
    for (const w of p) {
      St(() => w.seq1Range.start - N === w.seq2Range.start - v);
      const _ = w.seq1Range.start - N;
      y(_), N = w.seq1Range.endExclusive, v = w.seq2Range.endExclusive;
      const A = this.refineDiff(e, n, w, s, i, r);
      A.hitTimeout && (g = !0);
      for (const D of A.mappings)
        d.push(D);
    }
    y(e.length - N);
    const L = new xt(e), E = new xt(n), T = es(d, L, E);
    let I = [];
    return r.computeMoves && (I = this.computeMoves(T, e, n, u, c, s, i, r)), St(() => {
      function w(A, D) {
        if (A.lineNumber < 1 || A.lineNumber > D.length)
          return !1;
        const B = D[A.lineNumber - 1];
        return !(A.column < 1 || A.column > B.length + 1);
      }
      function _(A, D) {
        return !(A.startLineNumber < 1 || A.startLineNumber > D.length + 1 || A.endLineNumberExclusive < 1 || A.endLineNumberExclusive > D.length + 1);
      }
      for (const A of T) {
        if (!A.innerChanges)
          return !1;
        for (const D of A.innerChanges)
          if (!(w(D.modifiedRange.getStartPosition(), n) && w(D.modifiedRange.getEndPosition(), n) && w(D.originalRange.getStartPosition(), e) && w(D.originalRange.getEndPosition(), e)))
            return !1;
        if (!_(A.modified, n) || !_(A.original, e))
          return !1;
      }
      return !0;
    }), new Nt(T, I, g);
  ...
  computeMoves(e, n, r, s, i, l, o, u) {
    return e1(e, n, r, s, i, l).map((m) => {
      const f = this.refineDiff(n, r, new O(m.original.toOffsetRange(), m.modified.toOffsetRange()), l, o, u), p = es(f.mappings, new xt(n), new xt(r), !0);
      return new ka(m, p);
    });
  }
  refineDiff(e, n, r, s, i, l) {
    const u = m1(r).toRangeMapping2(e, n), c = new Tt(e, u.originalRange, i), h = new Tt(n, u.modifiedRange, i), m = c.length + h.length < 500 ? this.dynamicProgrammingDiffing.compute(c, h, s) : this.myersDiffingAlgorithm.compute(c, h, s);
    let f = m.diffs;
    return f = os(c, h, f), f = hs(c, h, f, (g, d) => g.findWordContaining(d)), l.extendToSubwords && (f = hs(c, h, f, (g, d) => g.findSubWordContaining(d), !0)), f = l1(c, h, f), f = c1(c, h, f), {
      mappings: f.map((g) => new le(c.translateRange(g.seq1Range), h.translateRange(g.seq2Range))),
      hitTimeout: m.hitTimeout
    };
  }
}
function m1(t) {
  return new ue(new $(t.seq1Range.start + 1, t.seq1Range.endExclusive + 1), new $(t.seq2Range.start + 1, t.seq2Range.endExclusive + 1));
}
const ds = {
  getLegacy: () => new Ga(),
  getDefault: () => new h1()
...
class b {
  constructor(e, n, r, s = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, e)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, r)) | 0, this.a = Se(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(e, n) {
...
class oe {
  constructor(e, n, r, s) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, e), 0) | 0, this.s = Se(Math.max(Math.min(1, n), 0), 3), this.l = Se(Math.max(Math.min(1, r), 0), 3), this.a = Se(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(e, n) {
   ...
   */
  static fromRGBA(e) {
    const n = e.r / 255, r = e.g / 255, s = e.b / 255, i = e.a, l = Math.max(n, r, s), o = Math.min(n, r, s);
    let u = 0, c = 0;
    const h = (o + l) / 2, m = l - o;
    if (m > 0) {
      switch (c = Math.min(h <= 0.5 ? m / (2 * h) : m / (2 - 2 * h), 1), l) {
        case n:
          u = (r - s) / m + (r < s ? 6 : 0);
          break;
        case r:
...
class He {
  constructor(e, n, r, s) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, e), 0) | 0, this.s = Se(Math.max(Math.min(1, n), 0), 3), this.v = Se(Math.max(Math.min(1, r), 0), 3), this.a = Se(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(e, n) {
  ...
  static fromRGBA(e) {
    const n = e.r / 255, r = e.g / 255, s = e.b / 255, i = Math.max(n, r, s), l = Math.min(n, r, s), o = i - l, u = i === 0 ? 0 : o / i;
    let c;
    return o === 0 ? c = 0 : i === n ? c = ((r - s) / o % 6 + 6) % 6 : i === r ? c = (s - n) / o + 2 : c = (n - r) / o + 4, new He(Math.round(c * 60), u, i, e.a);
  }
  // from http://www.rapidtables.com/convert/color/hsv-to-rgb.htm
  static toRGBA(e) {
    const { h: n, s: r, v: s, a: i } = e, l = s * r, o = l * (1 - Math.abs(n / 60 % 2 - 1)), u = s - l;
    let [c, h, m] = [0, 0, 0];
    return n < 60 ? (c = l, h = o) : n < 120 ? (c = o, h = l) : n < 180 ? (h = l, m = o) : n < 240 ? (h = o, m = l) : n < 300 ? (c = o, m = l) : n <= 360 && (c = l, m = o), c = Math.round((c + u) * 255), h = Math.round((h + u) * 255), m = Math.round((m + u) * 255), new b(c, h, m, i);
  }
}
const z = class z {
  static fromHex(e) {
  ...
  constructor(e) {
    if (e)
      if (e instanceof b)
        ...
        this._hsva = e, this.rgba = He.toRGBA(e);
      else
        throw new Error("Invalid color ctor argument");
    else throw new Error("Color needs a value");
  }
  equals(e) {
    return !!e && b.equals(this.rgba, e.rgba) && oe.equals(this.hsla, e.hsla) && He.equals(this.hsva, e.hsva);
  }
  /**
  ...
  getRelativeLuminance() {
    const e = z._relativeLuminanceForComponent(this.rgba.r), n = z._relativeLuminanceForComponent(this.rgba.g), r = z._relativeLuminanceForComponent(this.rgba.b), s = 0.2126 * e + 0.7152 * n + 0.0722 * r;
    return Se(s, 4);
  }
   ...
   */
  mix(e, n = 0.5) {
    const r = Math.min(Math.max(n, 0), 1), s = this.rgba, i = e.rgba, l = s.r + (i.r - s.r) * r, o = s.g + (i.g - s.g) * r, u = s.b + (i.b - s.b) * r, c = s.a + (i.a - s.a) * r;
  ...
  makeOpaque(e) {
    if (this.isOpaque() || e.rgba.a !== 1)
      return this;
    const { r: n, g: r, b: s, a: i } = this.rgba;
    return new z(new b(e.rgba.r - i * (e.rgba.r - n), e.rgba.g - i * (e.rgba.g - r), e.rgba.b - i * (e.rgba.b - s), 1));
  }
  toString() {
...
z.white = new z(new b(255, 255, 255, 1)), z.black = new z(new b(0, 0, 0, 1)), z.red = new z(new b(255, 0, 0, 1)), z.blue = new z(new b(0, 0, 255, 1)), z.green = new z(new b(0, 255, 0, 1)), z.cyan = new z(new b(0, 255, 255, 1)), z.lightgrey = new z(new b(211, 211, 211, 1)), z.transparent = new z(new b(0, 0, 0, 0));
let et = z;
(function(t) {
  (function(e) {
    (function(n) {
      ...
      n.formatHex = u;
      function c(d, y = !1) {
        return y && d.rgba.a === 1 ? t.Format.CSS.formatHex(d) : `#${o(d.rgba.r)}${o(d.rgba.g)}${o(d.rgba.b)}${o(Math.round(d.rgba.a * 255))}`;
      }
      n.formatHexA = c;
      function h(d) {
      ...
      function m(d) {
        ...
        if (d.startsWith("rgba(")) {
          const y = d.match(/rgba\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+), *(?<a>(?:\+|-)?\d+(\.\d+)?)\)/);
          if (!y)
            throw new Error("Invalid color format " + d);
          const N = parseInt(y.groups?.r ?? "0"), v = parseInt(y.groups?.g ?? "0"), L = parseInt(y.groups?.b ?? "0"), E = parseFloat(y.groups?.a ?? "0");
          return new t(new b(N, v, L, E));
        }
        if (d.startsWith("rgb(")) {
          const y = d.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
          if (!y)
            throw new Error("Invalid color format " + d);
          const N = parseInt(y.groups?.r ?? "0"), v = parseInt(y.groups?.g ?? "0"), L = parseInt(y.groups?.b ?? "0");
          return new t(new b(N, v, L));
        }
        return f(d);
      }
      n.parse = m;
      ...
      function p(d) {
        const y = d.length;
        if (y === 0 || d.charCodeAt(0) !== 35)
          return null;
        if (y === 7) {
          const N = 16 * g(d.charCodeAt(1)) + g(d.charCodeAt(2)), v = 16 * g(d.charCodeAt(3)) + g(d.charCodeAt(4)), L = 16 * g(d.charCodeAt(5)) + g(d.charCodeAt(6));
          return new t(new b(N, v, L, 1));
        }
        if (y === 9) {
          const N = 16 * g(d.charCodeAt(1)) + g(d.charCodeAt(2)), v = 16 * g(d.charCodeAt(3)) + g(d.charCodeAt(4)), L = 16 * g(d.charCodeAt(5)) + g(d.charCodeAt(6)), E = 16 * g(d.charCodeAt(7)) + g(d.charCodeAt(8));
          return new t(new b(N, v, L, E / 255));
        }
        if (y === 4) {
          const N = g(d.charCodeAt(1)), v = g(d.charCodeAt(2)), L = g(d.charCodeAt(3));
          return new t(new b(16 * N + N, 16 * v + v, 16 * L + L));
        }
        if (y === 5) {
          const N = g(d.charCodeAt(1)), v = g(d.charCodeAt(2)), L = g(d.charCodeAt(3)), E = g(d.charCodeAt(4));
...
function f1(t, e) {
  if (!t)
    return;
  const n = et.Format.CSS.parseHex(e);
  if (n)
    return {
      range: t,
...
function bs(t, e, n) {
  if (!t || e.length !== 1)
    return;
  const s = e[0].values(), i = Bs(s), l = new et(new oe(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
  return {
    range: t,
    color: An(l.rgba.r, l.rgba.g, l.rgba.b, l.rgba.a)
  };
}
function st(t, e) {
...
function d1(t) {
  const e = [], n = new RegExp(`\\b(rgb|rgba|hsl|hsla)(\\([0-9\\s,.\\%]*\\))|^(#)([A-Fa-f0-9]{3})\\b|^(#)([A-Fa-f0-9]{4})\\b|^(#)([A-Fa-f0-9]{6})\\b|^(#)([A-Fa-f0-9]{8})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{3})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{4})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{6})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{8})\\b`, "gm"), r = st(t, n);
  if (r.length > 0)
    for (const s of r) {
      ...
      if (l === "rgb") {
        ...
        u = bs(rt(t, s), st(o, c), !0);
      } else l === "#" && (u = f1(rt(t, s), l + o));
      u && e.push(u);
    }
  return e;
}
...
function x1(t, e) {
  ...
  if (bi(i))
    return n;
  for (let l = 1; l <= r; l += ps - p1) {
    const o = Math.min(l + ps - 1, r), u = [];
    for (let m = l; m <= o; m++)
      u.push(t.getLineContent(m));
    const c = u.join(`
`);
    i.lastIndex = 0;
    let h;
    for (; (h = i.exec(c)) !== null; ) {
      const m = c.substring(0, h.index), f = (m.match(/\n/g) || []).length, p = l + f, g = h[0].split(`
`), d = g.length, y = p + d - 1, N = m.lastIndexOf(`
`) + 1, v = h.index - N + 1, L = g[g.length - 1], E = d === 1 ? v + h[0].length : L.length + 1, T = {
        startLineNumber: p,
        startColumn: v,
        endLineNumber: y,
        endColumn: E
      }, I = (h.groups ?? {}).label ?? "", w = ((h.groups ?? {}).separator ?? "") !== "", _ = {
        range: T,
        text: I,
        hasSeparatorLine: w,
        shouldBeInComments: !0
      };
      (_.text || _.hasSeparatorLine) && (n.length === 0 || n[n.length - 1].range.endLineNumber < _.range.startLineNumber) && n.push(_), i.lastIndex = h.index + h[0].length;
    }
  }
  return n;
}
...
(function(t) {
  async function e(r) {
    let s;
    const i = await Promise.all(r.map((l) => l.then((o) => o, (o) => {
      s || (s = o);
    })));
    if (typeof s < "u")
      throw s;
...
class N1 {
  ...
  setValue(e, n) {
    return e = Ie(e), n = Ie(n), this.values[e] === n ? !1 : (this.values[e] = n, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0);
  }
  removeValues(e, n) {
    e = Ie(e), n = Ie(n);
   ...
   */
  getPrefixSum(e) {
    return e < 0 ? 0 : (e = Ie(e), this._getPrefixSum(e));
  }
  _getPrefixSum(e) {
...
class R1 {
  ...
  $acceptNewModel(e) {
    this._models[e.url] = new C1(Fe.parse(e.url), e.lines, e.EOL, e.versionId);
  }
...
class C1 extends A1 {
  ...
  findMatches(e) {
    ...
    for (let r = 0; r < this._lines.length; r++) {
      const s = this._lines[r], i = this.offsetAt(new H(r + 1, 1)), l = s.matchAll(e);
      for (const o of l)
  ...
  getWordAtPosition(e, n) {
    const r = Sn(e.column, Ts(n), this._lines[e.lineNumber - 1], 0);
...
const Me = class Me {
  constructor(e = null) {
    this._foreignModule = e, this._workerTextModelSyncServer = new R1();
  }
  dispose() {
  }
  async $ping() {
  ...
  async $computeDiff(e, n, r, s) {
    const i = this._getModel(e), l = this._getModel(n);
    return !i || !l ? null : Me.computeDiff(i, l, r, s);
  }
  static computeDiff(e, n, r, s) {
    const i = s === "advanced" ? ds.getDefault() : ds.getLegacy(), l = e.getLinesContent(), o = n.getLinesContent(), u = i.computeDiff(l, o, r), c = u.changes.length > 0 ? !1 : this._modelsAreIdentical(e, n);
    function h(m) {
      return m.map((f) => [f.original.startLineNumber, f.original.endLineNumberExclusive, f.modified.startLineNumber, f.modified.endLineNumberExclusive, f.innerChanges?.map((p) => [
  ...
  static _modelsAreIdentical(e, n) {
    ...
    if (r !== s)
      return !1;
    for (let i = 1; i <= r; i++) {
      const l = e.getLineContent(i), o = n.getLineContent(i);
      if (l !== o)
        return !1;
    }
    return !0;
  ...
  async $computeMoreMinimalEdits(e, n, r) {
    ...
    n = n.slice(0).sort((u, c) => {
      ...
      const h = u.range ? 0 : 1, m = c.range ? 0 : 1;
      return h - m;
    });
    let o = 0;
    for (let u = 1; u < n.length; u++)
      C.getEndPosition(n[o].range).equals(C.getStartPosition(n[u].range)) ? (n[o].range = C.fromPositions(C.getStartPosition(n[o].range), C.getEndPosition(n[u].range)), n[o].text += n[u].text) : (o++, n[o] = n[u]);
    n.length = o + 1;
    for (let { range: u, text: c, eol: h } of n) {
      if (typeof h == "number" && (l = h), C.isEmpty(u) && !c)
        continue;
      const m = s.getValueInRange(u);
      if (c = c.replace(/\r\n|\n|\r/g, s.eol), m === c)
        continue;
      if (Math.max(c.length, m.length) > Me._diffLimit) {
        i.push({ range: u, text: c });
        continue;
      }
      const f = Vi(m, c, r), p = s.offsetAt(C.lift(u).getStartPosition());
      for (const g of f) {
        const d = s.positionAt(p + g.originalStart), y = s.positionAt(p + g.originalStart + g.originalLength), N = {
          text: c.substr(g.modifiedStart, g.modifiedLength),
          range: { startLineNumber: d.lineNumber, startColumn: d.column, endLineNumber: y.lineNumber, endColumn: y.column }
        };
  ...
  async $textualSuggest(e, n, r, s) {
    const i = new Ut(), l = new RegExp(r, s), o = /* @__PURE__ */ new Set();
    e: for (const u of e) {
      const c = this._getModel(u);
      if (c) {
        for (const h of c.words(l))
          if (!(h === n || !isNaN(Number(h))) && (o.add(h), o.size > Me._suggestionsLimit))
            break e;
      }
    }
...
Me._diffLimit = 1e5, Me._suggestionsLimit = 1e4;
let xn = Me;
