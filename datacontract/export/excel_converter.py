...
from datacontract.model.data_contract_specification import DataContractSpecification, Info, Contact
...
class SchemaBasicInfo:
    ...
    type: ContractElements  = field(default_factory=lambda: ContractElements(
    ...
    business_name: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(1, 8, "Business Name"),
        layout="column",
        cells=[],
    ))
    physical_name: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(1, 9, "Physical Name"),
        layout="column",
        cells=[],
    ))
    data_granularity: ContractElements  = field(default_factory=lambda: ContractElements(
...
class SchemaFullInfo():
    property: ContractElements  = field(default_factory=lambda: ContractElements(
    ...
    logical_type: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(3, 13, "Logical Type"),
        layout="column",
        cells=[],
    ))
    physical_type: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(4, 13, "Physical Type"),
        layout="column",
        cells=[],
    ))
    examples: ContractElements  = field(default_factory=lambda: ContractElements(
    ...
    required: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(7, 13, "Required"),
        layout="column",
        cells=[],
    ))
    unique: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(8, 13, "Unique"),
        layout="column",
        cells=[],
    ))
    classification: ContractElements  = field(default_factory=lambda: ContractElements(
    ...
    quality_type: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(11, 13, "Quality Type"),
        layout="column",
        cells=[],
    ))
    quality_description: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(12, 13, "Quality Description"),
        layout="column",
        cells=[],
    ))
    authoritative_definition_url: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(13, 13, "Authoritative Definition URL"),
        layout="column",
        cells=[],
    ))
    authoritative_definition_type: ContractElements  = field(default_factory=lambda: ContractElements(
    ...
    primary_key: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(16, 13, "Primary Key"),
        layout="column",
        cells=[],
    ))
    primary_key_position: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(17, 13, "Primary Key Position"),
        layout="column",
        cells=[],
    ))
    partitioned: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(18, 13, "Partitioned"),
        layout="column",
        cells=[],
    ))
    partition_key_position: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(19, 13, "Partition Key Position"),
        layout="column",
        cells=[],
    ))
    encrypted_name: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(20, 13, "Encrypted Name"),
        layout="column",
        cells=[],
    ))
    transform_sources: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(21, 13, "Transform Sources"),
        layout="column",
        cells=[],
    ))
    transform_logic: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(22, 13, "Transform Logic"),
        layout="column",
        cells=[],
    ))
    transform_description: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(23, 13, "Transform Description"),
        layout="column",
        cells=[],
    ))
    critical_data_element_status: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(24, 13, "Critical Data Element Status"),
        layout="column",
        cells=[],
    ))
    maximum_items: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(25, 13, "Maximum Items"),
        layout="column",
        cells=[],
    ))
    minimum_items: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(26, 13, "Minimum Items"),
        layout="column",
        cells=[],
    ))
    unique_items: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(27, 13, "Unique Items"),
        layout="column",
        cells=[],
    ))
    format: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(28, 13, "Format"),
        layout="column",
        cells=[],
    ))
    minimum_length: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(29, 13, "Minimum Length"),
        layout="column",
        cells=[],
    ))
    maximum_length: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(30, 13, "Maximum Length"),
        layout="column",
        cells=[],
    ))
    exclusive_minimum: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(31, 13, "Exclusive Minimum"),
        layout="column",
        cells=[],
    ))
    minimum: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(32, 13, "Minimum"),
        layout="column",
        cells=[],
    ))
    exclusive_maximum: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(33, 13, "Exclusive Maximum"),
        layout="column",
        cells=[],
    ))
    maximum: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(34, 13, "Maximum"),
        layout="column",
        cells=[],
    ))
    multiple_of: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(35, 13, "Multiple Of"),
        layout="column",
        cells=[],
    ))
    minimum_properties: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(36, 13, "Minimum Properties"),
        layout="column",
        cells=[],
    ))
    maximum_properties: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(37, 13, "Maximum Properties"),
        layout="column",
        cells=[],
    ))
    required_properties: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(38, 13, "Required Properties"),
        layout="column",
        cells=[],
    ))
    pattern: ContractElements  = field(default_factory=lambda: ContractElements(
...
@dataclass
class Pricing():
    price_amount: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(2, 4, "Price Amount"),
        layout="column",
        cells=[],
    ))
    price_currency: ContractElements  = field(default_factory=lambda: ContractElements(
        header_cell=CellValue(2, 5, "Price Currency"),
        layout="column",
        cells=[],
    ))
    price_unit: ContractElements  = field(default_factory=lambda: ContractElements(
...
def _populate_schema_field_data(schema_detailed_info, field, counter: int):
    ...
    field_mappings = [
        ...
        (schema_detailed_info.examples, _format_list_value(getattr(field, "examples", []))),
        ...
        (schema_detailed_info.quality_description, _safe_getattr(field, "qualityDescription")),
        (schema_detailed_info.quality_type, _safe_getattr(field, "qualityType")),
        (schema_detailed_info.authoritative_definition_url, _safe_getattr(field, "authoritativeDefinitionUrl")),
        (schema_detailed_info.authoritative_definition_type, _safe_getattr(field, "authoritativeDefinitionType")),
        (schema_detailed_info.physical_name, _safe_getattr(field, "physicalName")),
        (schema_detailed_info.primary_key, _format_list_value(getattr(field, "primary", []))),
        (schema_detailed_info.primary_key_position, _safe_getattr(field, "primaryKeyPosition")),
        (schema_detailed_info.partitioned, _safe_getattr(field, "partitioned")),
        (schema_detailed_info.partition_key_position, _safe_getattr(field, "partitionKeyPosition")),
        (schema_detailed_info.encrypted_name, _safe_str_getattr(field, "encryptedName")),
        (schema_detailed_info.transform_sources, _format_list_value(getattr(field, "transformSources", []))),
        (schema_detailed_info.transform_logic, _safe_getattr(field, "transformLogic")),
        (schema_detailed_info.transform_description, _safe_getattr(field, "transformDescription")),
        (schema_detailed_info.critical_data_element_status, _safe_str_getattr(field, "criticalDataElementStatus")),
        ...
        (schema_detailed_info.minimum_length, _safe_str_getattr(field, "minimumLength")),
        (schema_detailed_info.maximum_length, _safe_str_getattr(field, "maximumlength")),
        (schema_detailed_info.exclusive_minimum, _safe_str_getattr(field, "exclusiveMinimum")),
        (schema_detailed_info.minimum, _safe_str_getattr(field, "minimum")),
        (schema_detailed_info.exclusive_maximum, _safe_str_getattr(field, "exclusiveMaximum")),
        ...
        (schema_detailed_info.minimum_properties, _safe_str_getattr(field, "minimumProperties")),
        (schema_detailed_info.maximum_properties, _safe_str_getattr(field, "maximumProperties")),
        (schema_detailed_info.required_properties, "".join(getattr(field, "requiredProperties", []) or [])),
...
def _populate_support_field_info(
    support_field_info,
    info_field,
    counter: int
) -> None:
...
def write_to_sheet(sheet_mapped_obj, worksheet: Worksheet):
    ...
    for field in fields(sheet_mapped_obj):
        ...
        for contract_element_cell in getattr(sheet_mapped_obj, field.name).cells:
            ...
            print(f"Writing to cell at ({row_position}, {column_position}): {contract_element_cell.value}")
