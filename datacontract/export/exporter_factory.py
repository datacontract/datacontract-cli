...
exporter_factory.register_lazy_exporter(
    ...
    module_path="datacontract.export.avro_exporter",
    class_name="AvroExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.avro_idl,
    module_path="datacontract.export.avro_idl_exporter",
    class_name="AvroIdlExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.bigquery,
    module_path="datacontract.export.bigquery_exporter",
    class_name="BigQueryExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.data_caterer,
    module_path="datacontract.export.data_caterer_exporter",
    class_name="DataCatererExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.dbml,
    module_path="datacontract.export.dbml_exporter",
    class_name="DbmlExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.rdf,
    module_path="datacontract.export.rdf_exporter",
...
exporter_factory.register_lazy_exporter(
    ...
    module_path="datacontract.export.jsonschema_exporter",
...
exporter_factory.register_lazy_exporter(
    ...
    module_path="datacontract.export.go_exporter",
    class_name="GoExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.great_expectations,
    module_path="datacontract.export.great_expectations_exporter",
...
exporter_factory.register_lazy_exporter(
    ...
    module_path="datacontract.export.protobuf_exporter",
    class_name="ProtoBufExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.pydantic_model,
    module_path="datacontract.export.pydantic_exporter",
    class_name="PydanticExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.sodacl,
    module_path="datacontract.export.sodacl_exporter",
    class_name="SodaExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.sql,
    module_path="datacontract.export.sql_exporter",
...
exporter_factory.register_lazy_exporter(
    ...
    module_path="datacontract.export.markdown_exporter",
    class_name="MarkdownExporter",
)

exporter_factory.register_lazy_exporter(
    name=ExportFormat.dqx,
    module_path="datacontract.export.dqx_exporter",
...
exporter_factory.register_lazy_exporter(
    name=ExportFormat.custom, module_path="datacontract.export.custom_exporter", class_name="CustomExporter"
)
