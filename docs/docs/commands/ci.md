...
Run tests for CI/CD pipelines. Wraps [`test`](./test.md) with CI-specific features: GitHub Actions annotations and step summary, Azure DevOps annotations, machine-readable output, and exit-code control. See [Scheduling and CI/CD](../ci-cd.md) for full pipeline examples.
