...
Run schema and quality tests on the servers configured in the contract. See **[Test your Data](../testing/index.md)** for connection details and supported data sources.
