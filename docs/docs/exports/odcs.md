...
This is also the command that converts a legacy DCS contract — see [Migrate from DCS to ODCS](../migrate-dcs-to-odcs.md).
...
All options: **[`datacontract export odcs`](../commands/export/odcs.md)**.
