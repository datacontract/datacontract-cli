...
SodaCL checks top-level columns only. Nested properties are left out, and the export prints a warning naming them.

All options: **[`datacontract export sodacl`](../commands/export/sodacl.md)**.
