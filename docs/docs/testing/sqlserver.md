...
Run `datacontract test datacontract.yaml` again: every violation is listed as an error, and the command exits with code `1` — ready for [CI/CD](../ci-cd.md) and [scheduled runs](../scheduling/index.md) so you catch drift before your consumers do.
