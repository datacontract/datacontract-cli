...
def test_no_breaking_changes():
    result = runner.invoke(app, ["breaking", "./examples/breaking/datacontract-fields-filled.yaml",
                                 "./examples/breaking/datacontract-fields-filled.yaml"])
...
class TestBreakingModels:
    class TestModelsAdded:
        ...
        def output(self):
            result = runner.invoke(app, ["breaking", "./examples/breaking/datacontract-models-empty.yaml",
                                         "./examples/breaking/datacontract-models-filled.yaml"])
            assert result.exit_code == 0
    ...
    class TestModelsRemoved:
        ...
        @pytest.fixture(scope='class')
        def output(self):
            result = runner.invoke(app, ["breaking", "./examples/breaking/datacontract-models-filled.yaml",
                                         "./examples/breaking/datacontract-models-empty.yaml"])
        ...
        def test_model_removed(self, output):
            assert r"""error   [model_removed] at ./examples/breaking/datacontract-models-empty.yaml
    ...
    class TestModelsUpdated:
        ...
        def output(self):
            result = runner.invoke(app, ["breaking", "./examples/breaking/datacontract-models-filled.yaml",
                                         "./examples/breaking/datacontract-models-filled-updated.yaml"])
            assert result.exit_code == 1
            return result.stdout
        ...
        def test_model_type_updated(self, output):
            assert r"""error   [model_type_updated] at 
./examples/breaking/datacontract-models-filled-updated.yaml
...
class TestBreakingFields:
    class TestFieldsAdded:
        ...
        @pytest.fixture(scope='class')
        def output(self):
            result = runner.invoke(app, ["breaking", "./examples/breaking/datacontract-fields-empty.yaml",
                                         "./examples/breaking/datacontract-fields-filled.yaml"])
            assert result.exit_code == 0
            return result.stdout
...
./examples/breaking/datacontract-fields-filled.yaml
        ...
        def test_pii_added(self, output):
            assert r"""warning [field_pii_added] at ./examples/breaking/datacontract-fields-filled.yaml
...
./examples/breaking/datacontract-fields-empty.yaml
        ...
        def test_nested_field_removed(self, output):
            assert r"""error   [field_removed] at ./examples/breaking/datacontract-fields-empty.yaml
    ...
    class TestFieldsUpdated:
        ...
        def output(self):
            result = runner.invoke(app, ["breaking", "./examples/breaking/datacontract-fields-filled.yaml",
                                         "./examples/breaking/datacontract-fields-filled-updated.yaml"])
            assert result.exit_code == 1
            return result.stdout
...
./examples/breaking/datacontract-fields-filled-updated.yaml
        ...
        def test_enum_updated(self, output):
            assert r"""error   [field_enum_updated] at 
./examples/breaking/datacontract-fields-filled-updated.yaml
        in models -> my_table -> field_enum -> enum
        ...
        def test_nested_type_updated(self, output):
            assert r"""error   [field_type_updated] at 
./examples/breaking/datacontract-fields-filled-updated.yaml
        in models -> my_table -> field_fields -> fields -> nested_field_1 -> 
type
            changed from `string` to `integer`""" in output
