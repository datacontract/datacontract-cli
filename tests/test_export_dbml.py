...
Table orders {{
    ...
    order_total STRUCT(amount STRUCT(sum DECIMAL, currency VARCHAR), due_date DATE, discount DOUBLE) [not null, note: "Total amount the smallest monetary unit (e.g., cents)."]
