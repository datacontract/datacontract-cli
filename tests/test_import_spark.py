...
def test_prog(spark: SparkSession, user_datacontract_no_desc, user_datacontract_desc):
    ...
    result3 = DataContract().import_from_source("spark", "user", dataframe = df_user)
    ...
    result4 = DataContract().import_from_source("spark", "user", dataframe = df_user, description = "description")
